...
export function Booking({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <Card
      className={cn("grid grid-cols-[1fr_auto_1fr] gap-0 p-0", className)}
      {...props}
    >
      <div className="space-y-4 border-r p-6">
        ...
        <h1 className="text-xl font-semibold tracking-tight">30 min meeting</h1>
      ...
      <div className="border-l">
        <div className="flex items-center justify-between gap-2 px-6 pt-6">
          ...
          <ToggleButtonGroup variant="primary">
