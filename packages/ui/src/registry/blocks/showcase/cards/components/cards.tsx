import { AccountMenu } from "@dotui/ui/registry/blocks/showcase/cards/components/account-menu";
import { Backlog } from "@dotui/ui/registry/blocks/showcase/cards/components/backlog";
import { Booking } from "@dotui/ui/registry/blocks/showcase/cards/components/booking";
import { ColorEditor } from "@dotui/ui/registry/blocks/showcase/cards/components/color-editor";
import { Filters } from "@dotui/ui/registry/blocks/showcase/cards/components/filters";
import { InviteMembers } from "@dotui/ui/registry/blocks/showcase/cards/components/invite-members";
import { LoginForm } from "@dotui/ui/registry/blocks/showcase/cards/components/login-form";
import { Notifications } from "@dotui/ui/registry/blocks/showcase/cards/components/notifications";
import { TeamName } from "@dotui/ui/registry/blocks/showcase/cards/components/team-name";
...
export function Cards() {
  return (
    <div className="grid grid-cols-11 gap-4 p-4 md:p-6">
      ...
      <Notifications className="max-md:h-100 col-span-11 md:col-span-5 md:[contain:size] xl:col-span-3" />
