...
const modalStyles = tv({
  slots: {
    underlay:
      "fixed top-0 left-0 z-50 flex h-(--visual-viewport-height) w-screen items-center justify-center bg-bg-inverse/40 opacity-100 duration-200 ease-[cubic-bezier(0.165,0.84,0.44,1)] will-change-[opacity] dark:bg-bg/40 entering:opacity-0 exiting:opacity-0",
    overlay:
