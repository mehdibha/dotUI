...
const inputStyles = tv({
  slots: {
    root: [
      focusInput(),
      "border-border-field bg-bg-neutral text-fg-muted shadow-xs inline-flex w-full cursor-text items-center justify-start gap-2 rounded-md border px-2 text-base transition-colors sm:text-sm [&_svg]:size-4",
