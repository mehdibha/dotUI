...
import { AlertTriangle, Circle, CircleDashedIcon, MoreHorizontal, Settings2Icon, Zap } from "lucide-react";
...
import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from "@dotui/registry/ui/card";
import { Label } from "@dotui/registry/ui/field";
import { Input } from "@dotui/registry/ui/input";
...
import { cn } from "@dotui/registry/lib/utils";
import { Button } from "@dotui/registry/ui/button";
import { Card, CardContent, CardFooter, CardHeader, CardTitle } from "@dotui/registry/ui/card";
	...
	return (
		<Card className={cn("", className)} {...props}>
			...
			<CardContent className="space-y-4">
				...
				<Slider defaultValue={[200, 800]} minValue={0} maxValue={2000} className="w-full">
	...
	return (
		<Card className={cn("", className)} {...props}>
			...
			<CardFooter className="flex items-center justify-between gap-4">
				<p className="text-fg-muted text-sm">Please use 32 characters at maximum.</p>
