...
const BreadcrumbItem = ({ className, ...props }: BreadcrumbItemProps) => (
	<AriaBreadcrumb className={composeRenderProps(className, (className) => item({ className }))} {...props} />
);
...
const BreadcrumbLink = ({ className, ...props }: BreadcrumbLinkProps) => (
	<AriaLink className={composeRenderProps(className, (className) => link({ className }))} {...props} />
);
...
const ColorArea = ({ className, ...props }: ColorAreaProps) => {
	return (
		<AriaColorArea className={composeRenderProps(className, (className) => colorAreaStyles({ className }))} {...props}>
...
import { Button } from "@dotui/registry/ui/button";
import { DialogContent, type DialogContentProps } from "@dotui/registry/ui/dialog";
...
const { content, header, heading, description, body, footer, inset } = dialogStyles();
...
interface InternalSwitchContextValue extends SwitchRenderProps, VariantProps<typeof switchStyles> {}
...
interface SwitchProps extends React.ComponentProps<typeof AriaSwitch>, VariantProps<typeof switchStyles> {}
