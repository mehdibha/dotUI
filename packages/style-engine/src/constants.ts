import type { ColorMode, TypographyScale } from "./types";

export const DEFAULT_REGISTRY_VARIANTS = {
  alert: "basic",
  avatar: "basic",
  badge: "basic",
  breadcrumbs: "basic",
...
export const DEFAULT_LIGHT_MODE: ColorMode = {
  lightness: 97,
  saturation: 100,
  palette: {
    neutral: {
...
export const DEFAULT_DARK_MODE: ColorMode = {
  lightness: 0,
  saturation: 100,
  palette: {
    neutral: {
      baseColors: ["#ffffff"],
      contrastRatios: [1, 1.25, 1.7, 2.23, 3.16, 4.78, 6.36, 8.28, 13.2, 15.2],
    },
    accent: {
      baseColors: ["#0091FF"],
      contrastRatios: [
