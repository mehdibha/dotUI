...
const setupMediaListener = createClientOnlyFn(
...
const setupStorageListener = createClientOnlyFn(
  (storageKey: string, callback: (theme: ThemeMode | null) => void) => {
...
export function ThemeProvider({
  ...
  return (
    <ThemeContext.Provider value={value}>
      <ScriptOnce>
        {createThemeScript(storageKey, defaultTheme, enableColorScheme)}
      </ScriptOnce>
      {children}
