...
export const colorTokensSchema = z.object({
  bg: colorTokenSchema,
  "bg-muted": colorTokenSchema,
  "bg-inverse": colorTokenSchema,
  "bg-disabled": colorTokenSchema,
  "bg-neutral": colorTokenSchema,
  "bg-neutral-hover": colorTokenSchema,
  "bg-neutral-active": colorTokenSchema,
  "bg-primary": colorTokenSchema,
  "bg-primary-hover": colorTokenSchema,
  "bg-primary-active": colorTokenSchema,
  "bg-primary-muted": colorTokenSchema,
  "bg-success": colorTokenSchema,
  "bg-success-hover": colorTokenSchema,
  "bg-success-active": colorTokenSchema,
  "bg-success-muted": colorTokenSchema,
  "bg-warning": colorTokenSchema,
  "bg-warning-hover": colorTokenSchema,
  "bg-warning-active": colorTokenSchema,
  "bg-warning-muted": colorTokenSchema,
  "bg-danger": colorTokenSchema,
  "bg-danger-hover": colorTokenSchema,
  "bg-danger-active": colorTokenSchema,
  "bg-danger-muted": colorTokenSchema,
  "bg-info": colorTokenSchema,
  "bg-info-hover": colorTokenSchema,
  "bg-info-active": colorTokenSchema,
  "bg-info-muted": colorTokenSchema,
  "bg-accent": colorTokenSchema,
  "bg-accent-hover": colorTokenSchema,
  "bg-accent-active": colorTokenSchema,
  "bg-accent-muted": colorTokenSchema,
  "bg-accent-muted-hover": colorTokenSchema,

  fg: colorTokenSchema,
  "fg-muted": colorTokenSchema,
  "fg-inverse": colorTokenSchema,
  "fg-disabled": colorTokenSchema,
  "fg-danger": colorTokenSchema,
  "fg-warning": colorTokenSchema,
  "fg-success": colorTokenSchema,
  "fg-info": colorTokenSchema,
  "fg-accent": colorTokenSchema,
  "fg-onNeutral": colorTokenSchema,
  "fg-onPrimary": colorTokenSchema,
  "fg-onAccent": colorTokenSchema,
  "fg-onSuccess": colorTokenSchema,
  "fg-onDanger": colorTokenSchema,
  "fg-onWarning": colorTokenSchema,
  "fg-onInfo": colorTokenSchema,

  border: colorTokenSchema,
  "border-hover": colorTokenSchema,
  "border-field": colorTokenSchema,
  "border-control": colorTokenSchema,
  "border-disabled": colorTokenSchema,
  "border-focus": colorTokenSchema,
  "border-success": colorTokenSchema,
  "border-accent": colorTokenSchema,
  "border-danger": colorTokenSchema,
  "border-warning": colorTokenSchema,
  "border-info": colorTokenSchema,
});
