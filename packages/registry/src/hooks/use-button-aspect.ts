...
export const useButtonAspect = <T extends Record<string, any> = any>(
	children: React.ReactNode | ((values: T & { defaultChildren: React.ReactNode }) => React.ReactNode),
	...
	const actualChildren =
		typeof children === "function" ? children({} as T & { defaultChildren: React.ReactNode }) : children;

	const traverseChildren = (children: React.ReactNode): { hasSelectValue: boolean; textContent: string } => {
