...
export const TagList = <T extends object>(props: TagListProps<T>) => {
	const Component = createDynamicComponent<TagListProps<T>>("tag-group", "TagList", Default.TagList, {});

	return <Component {...props} />;
};

export const Tag = createDynamicComponent<TagProps>("tag-group", "Tag", Default.Tag, {});
