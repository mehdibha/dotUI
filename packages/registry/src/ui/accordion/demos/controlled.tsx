			...
			<Accordion expandedKeys={expandedKeys} onExpandedChange={(keys) => setExpandedKeys(keys as Set<string>)}>
				<Disclosure id="getting-started">
					...
					<DisclosurePanel>
						...
						components you need. All components are built on React Aria Components and follow accessibility best
				...
				<Disclosure id="free-to-use">
					...
					<DisclosurePanel>
						Yes, DotUI is completely free and open source. You can use it in any project, whether personal or
						commercial, without any restrictions or licensing fees.
					</DisclosurePanel>
				</Disclosure>
