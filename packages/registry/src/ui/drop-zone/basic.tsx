...
const dropZoneStyles = tv({
  slots: {
    dropzone:
      "focus-visible:border-border-focus disabled:border-border-disabled disabled:text-fg-disabled drop-target:border-border-focus drop-target:bg-accent-muted flex w-60 flex-col items-center justify-center gap-2 rounded-md border-2 border-dashed p-6 text-sm",
    label: "text-base",
  },
});
