...
export const CaptionsIcon = createIcon({
    ...
    hugeicons: React.lazy(() => import("hugeicons-react").then(mod => ({ default: mod.TextCheckIcon }))),
});
...
export const ShieldIcon = createIcon({
    ...
    hugeicons: React.lazy(() => import("hugeicons-react").then(mod => ({ default: mod.Shield01Icon }))),
});
...
export const ActivityIcon = createIcon({
    ...
    hugeicons: React.lazy(() => import("hugeicons-react").then(mod => ({ default: mod.Activity01Icon }))),
});
...
export const TableIcon = createIcon({
    ...
    hugeicons: React.lazy(() => import("hugeicons-react").then(mod => ({ default: mod.TableIcon }))),
});
