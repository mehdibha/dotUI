...
export const AlertCircleIcon = createIcon({
    ...
    remix: React.lazy(() => import("@remixicon/react").then(mod => ({ default: mod.RiErrorWarningFill }))),
});
...
export const AsteriskIcon = createIcon({
    ...
    remix: React.lazy(() => import("@remixicon/react").then(mod => ({ default: mod.RiAsterisk }))),
});
...
export const UsersIcon = createIcon({
    ...
    remix: React.lazy(() => import("@remixicon/react").then(mod => ({ default: mod.RiGroupLine }))),
});

export const PlaneIcon = createIcon({
    lucide: Lucide.PlaneIcon,
    remix: React.lazy(() => import("@remixicon/react").then(mod => ({ default: mod.RiPlaneLine }))),
});
...
export const ALargeSmallIcon = createIcon({
    ...
    remix: React.lazy(() => import("@remixicon/react").then(mod => ({ default: mod.RiFontSize }))),
});
...
export const PenSquareIcon = createIcon({
    ...
    remix: React.lazy(() => import("@remixicon/react").then(mod => ({ default: mod.RiEditBoxLine }))),
});

export const GripVerticalIcon = createIcon({
    lucide: Lucide.GripVerticalIcon,
    remix: React.lazy(() => import("@remixicon/react").then(mod => ({ default: mod.RiDraggable }))),
});
