export interface Token {
	defaultValue: string;
	description?: string;
	categories?: ("color" | "typography" | "background" | "foreground" | "border" | "spacing" | "radius")[];
	scales?: ("neutral" | "accent" | "success" | "warning" | "danger" | "info" | "..")[];
}
...
export const COLOR_TOKENS: Record<string, Token> = {
	...
	"color-inverse": {
		...
		description: "Inverse background color for dark themes or contrasting areas",
		categories: ["background"],
		scales: ["neutral", ".."],
	},
	"color-disabled": {
	...
	"color-warning-muted": {
		...
		description: "Muted warning background color for subtle cautionary feedback",
		categories: ["background"],
		scales: ["warning"],
	},
	...
	"color-info": {
		...
		description: "Background color for informational states and neutral actions",
		categories: ["background"],
		scales: ["info"],
	},
	"color-info-hover": {
	...
	"color-info-muted": {
		...
		description: "Muted info background color for subtle informational feedback",
		categories: ["background"],
		scales: ["info"],
	},
	...
	"color-border-control": {
		...
		description: "Border color for control elements like checkboxes and toggles",
		categories: ["border"],
		scales: ["neutral", ".."],
	},
	...
	"color-border-focus": {
		defaultValue: "var(--accent-500)",
		description: "Border color for focused elements and accessibility indicators",
		categories: ["border"],
		scales: ["neutral", "accent", ".."],
	},
