...
import { ToggleButtonProvider } from "@dotui/registry-v2/ui/toggle-button";
import type { toggleButtonStyles } from "@dotui/registry-v2/ui/toggle-button";
...
const toggleGroupStyles = tv({
  ...
  variants: {
    orientation: {
      horizontal: {
        root: "flex-row has-data-[variant=default]:space-x-[-1px]",
        item: "first:rounded-l-md last:rounded-r-md",
      },
      vertical: {
        root: "flex-col has-data-[variant=default]:space-y-[-1px]",
