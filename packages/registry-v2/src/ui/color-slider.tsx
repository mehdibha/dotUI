...
const colorSliderStyles = tv({
  slots: {
    ...
    track:
      "disabled:[background:var(--color-disabled)]! relative rounded-md before:absolute before:inset-0 before:z-[-1] before:rounded-[inherit] before:bg-[repeating-conic-gradient(#e6e6e6_0%_25%,_#fff_0%_50%)] before:bg-[length:16px_16px] before:bg-center before:content-['']",
    thumb: "",
  },
  variants: {
    orientation: {
