...
import { ArrowRightIcon, BoldIcon, BookmarkIcon, Edit2Icon, ItalicIcon, PinIcon, SendIcon } from "lucide-react";
	...
	return (
		...
		>
			...
			<div className="flex items-center gap-2">
				...
				<ToggleButton aria-label="Toggle book" variant="default" className="selected:[&_svg]:fill-fg-on-primary">
					<BookmarkIcon />
				</ToggleButton>
			</div>
		</ComponentConfig>
