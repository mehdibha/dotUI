...
export const DemoClient = ({
	...
	return (
		<DemoContext.Provider value={{ isExpanded, toggleExpanded }}>
			<div {...props}>
				<ActiveStyleProvider unstyled className="flex items-stretch text-fg" skeletonClassName="rounded-t-md border">
					<DemoFrame className={previewClassName}>{component}</DemoFrame>
				</ActiveStyleProvider>
				<DemoCodeBlock highlightedPreview={highlightedPreview} highlightedSource={highlightedSource} />
			</div>
