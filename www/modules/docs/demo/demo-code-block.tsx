...
export const DemoCodeBlock = ({ highlightedPreview, highlightedSource }: DemoCodeBlockProps) => {
	...
	return (
		<ViewTransition default="code-fade">
			<CodeBlock
				...
				actions={
					<Button variant="quiet" size="sm" className="h-7 gap-1 pr-2 pl-1 text-xs" onPress={toggleExpanded}>
						{isExpanded ? (
							<>
								<ChevronUpIcon /> Code
							</>
