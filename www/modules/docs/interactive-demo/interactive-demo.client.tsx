...
export function InteractiveDemoClient({
	...
	const [layout, setLayout] = React.useState<"horizontal" | "vertical">(layoutProp);
			...
			<div className={cn("flex flex-col", layout === "horizontal" && "flex-row")}>
				...
				<div
					className={cn(
						...
						layout === "horizontal" && "-ml-4 min-w-48 rounded-tr-md border-y border-r pl-8",
						...
						<>
							...
							<Tooltip>
								<Button
									...
									onPress={() => setLayout((prev) => (prev === "horizontal" ? "vertical" : "horizontal"))}
									variant="quiet"
									size="sm"
									className="size-7"
								>
