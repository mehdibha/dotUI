...
export function DisclosureGroup({ title, defaultExpanded = false, children, colSpan = 4 }: DisclosureGroupProps) {
		...
		<tbody className="bg-bg">
			...
			<tr>
				<td colSpan={colSpan} className="border-b p-0">
					...
					>
						<ChevronRightIcon
							className={cn("size-4 text-fg-muted transition-transform duration-200", isExpanded && "rotate-90")}
						/>
						{title}
					</button>
				</td>
