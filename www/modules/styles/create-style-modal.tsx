...
export function CreateStyleModal({
	...
	return <CreateStyleModalContent initialStyle={initialStyle}>{children}</CreateStyleModalContent>;
}
					...
					>
						...
						<DialogBody>
							{createStyleMutation.isError && (
								<Alert
									variant="danger"
									title={createStyleMutation.error?.message ?? "An error occurred while creating the style."}
													...
													{({ selectedText, selectedItem }) => {
														const items = [
															...
															},
															{
																...
																description: "Anyone with the link can access this style.",
															},
															{
																value: "public",
																label: "Public",
																icon: <GlobeIcon />,
																description: "Anyone can view this style (listed in community styles).",
															},
														];
							...
							{renamedTo && (
								<Alert className="mt-3 font-normal text-xs">Your style will be renamed to "{renamedTo}"</Alert>
							)}
						</DialogBody>
						<DialogFooter>
