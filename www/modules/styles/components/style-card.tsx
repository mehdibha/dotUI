...
export function StyleCard({
  ...
  return (
    <div className="space-y-3 @container/style-card">
      <div className="max-w-xl space-y-2">
        ...
        <div
          className="relative flex @2xl/style-card:h-[300px] h-[250px] max-h-[min(80svh,500px)] items-center justify-center overflow-hidden rounded-sm border duration-0 min-[550px]:max-md:h-[300px]"
        >
          <Link
