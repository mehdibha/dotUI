...
export function StylesPageNav({ className, children }: { className?: string; children: React.ReactNode }) {
					...
					{items.map((tab) => (
						<Tab
							...
							className={cn(
								...
								isMounted && !isPending && "fade-in slide-in-from-bottom-1 animate-in opacity-100",
							)}
						>
							{tab.label}
						</Tab>
