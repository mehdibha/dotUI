				...
				default: {
					...
					variants: {
						variant: {
							...
							danger: { root: "text-fg-danger *:data-alert-description:text-fg-danger/90" },
							warning: { root: "text-fg-warning *:data-alert-description:text-fg-warning/90" },
							info: { root: "text-fg-info *:data-alert-description:text-fg-info/90" },
							success: { root: "text-fg-success *:data-alert-description:text-fg-success/90" },
						},
					},
