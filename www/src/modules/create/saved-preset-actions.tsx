...
/**
 * The actions menu on a saved preset's gallery tile: rename / duplicate / copy
 * link / delete. Sits on the tile's caption row, above the tile-wide select
 * overlay, so pressing it opens the menu instead of applying the preset.
 */
