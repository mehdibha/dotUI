...
export const ThemesOverview = () => {
  ...
  React.useEffect(() => {
    const interval = setInterval(() => {
      ...
      if (nextTheme) setCurrentThemeName(nextTheme.name);
    }, 5000);
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      <div className="relative flex flex-col items-end gap-2">
        <div className="absolute right-0 top-0 hidden translate-x-[calc(100%+10px)] translate-y-[calc(-100%+10px)] lg:block">
          <div>
            <svg
              width="30"
              viewBox="0 0 106 212"
        ...
        <svg
          ...
          viewBox="0 0 106 212"
          fill="none"
          className="text-fg/40 rotate-40 translate-x-10 lg:hidden"
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
            fillRule="evenodd"
