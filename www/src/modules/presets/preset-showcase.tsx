...
/**
 * A whole product screen rendered in one design system — the picker's preview
 * pane. Nothing here is a swatch grid: every axis reads off real UI, which is
 * how two systems become comparable at a glance (chrome density and control
 * height, field and button style, badge shape, card elevation, the heading face
 * on the app name and page title, the accent on the primary action).
 *
 * Scoped and inert: no iframe, no scaling, and nothing inside is focusable or
 * announced — the list rail owns the interaction.
 */
  ...
  return (
    ...
    >
      <div
        inert
        aria-hidden
        className="flex h-full flex-col bg-bg text-fg select-none"
      >
