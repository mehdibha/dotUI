...
export default function SettingsBlock() {
  ...
  return (
    ...
    <div className="relative flex h-svh items-center justify-center bg-bg p-4 text-fg sm:p-8">
      ...
      <SidebarProvider className="relative h-full max-h-184 min-h-0 w-full max-w-5xl overflow-hidden rounded-(--modal-radius) border border-(--overlay-border) bg-(--modal-background) shadow-(--shadow-modal,var(--shadow-lg)) [backdrop-filter:var(--overlay-backdrop-filter,none)]">
