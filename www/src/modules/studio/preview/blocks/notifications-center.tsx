  ...
  return (
    ...
    <div className="relative flex h-svh items-center justify-center bg-bg p-4 text-fg sm:p-8">
      ...
      <Tabs
        ...
        className="relative flex h-full max-h-184 w-full max-w-5xl flex-col gap-0 overflow-hidden rounded-(--studio-modal-radius) border border-(--overlay-border) bg-(--studio-modal-background) shadow-(--shadow-modal,var(--shadow-lg)) [backdrop-filter:var(--overlay-backdrop-filter,none)]"
      >
