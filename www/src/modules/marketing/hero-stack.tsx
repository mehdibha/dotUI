      ...
      {({ payload }) => {
        ...
        return (
          <Tooltip.Portal>
            ...
            >
              <Tooltip.Popup className="rounded-(--studio-tooltip-radius) border border-border bg-neutral px-3 py-1.5 text-xs text-fg-on-neutral shadow-(--shadow-overlay,none) transition-[opacity,scale] duration-150 data-ending-style:scale-95 data-ending-style:opacity-0 data-starting-style:scale-95 data-starting-style:opacity-0">
