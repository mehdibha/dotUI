      ...
      <div className="container">
        ...
        <section className="flex flex-col pt-10 sm:pt-14 md:pt-20">
          <div className="flex flex-col items-center text-center">
            <HeroEyebrow />
            <h1 className="font-features-['calt'_0,'rlig','ss11'] text-[clamp(1.75rem,calc((100vw-2rem)/8.5),3rem)] leading-[1.17] font-normal tracking-[-0.06em] text-balance antialiased sm:text-[3rem] sm:leading-14 xl:text-6xl xl:leading-16">
