...
function Placeholder({ code, components = {} }: { code: string; components: HighlightOptions["components"] }) {
...
function ShikiHighlighter({ id, code, options }: { id: string; code: string; options: HighlightOptions }) {
