...
export const componentsData: ComponentCategory[] = [
	{
		...
		slug: "buttons",
		components: [
			{ name: "Button", slug: "button", href: "/docs/components/button", scale: 1, done: true },
	...
	},
	{
		...
		slug: "inputs",
		components: [
			{ name: "Input", slug: "input", href: "/docs/components/input", done: true },
			{ name: "TextArea", slug: "text-area", href: "/docs/components/text-area", done: true },
	...
	},
	{
		...
		components: [
			...
			{ name: "Combobox", slug: "combobox", href: "/docs/components/combobox", scale: 0.7, iframe: true, done: true },
			{ name: "Select", slug: "select", href: "/docs/components/select", scale: 0.7, iframe: true, done: true },
		],
	},
	{
		title: "Dates",
		...
		components: [
			...
			{ name: "DateField", slug: "date-field", href: "/docs/components/date-field", scale: 0.7, done: true },
			{ name: "DatePicker", slug: "date-picker", href: "/docs/components/date-picker", scale: 0.4, done: true },
	...
	},
	{
		...
		slug: "feedback",
		components: [
			{ name: "Alert", slug: "alert", href: "/docs/components/alert", scale: 0.5, done: true },
	...
	},
	{
		...
		slug: "collections",
		components: [
			{ name: "ListBox", slug: "list-box", href: "/docs/components/list-box", done: true },
			{ name: "TagGroup", slug: "tag-group", href: "/docs/components/tag-group", done: true },
		],
	},
	{
		title: "Navigation",
		...
		components: [
			...
			{ name: "Breadcrumbs", slug: "breadcrumbs", href: "/docs/components/breadcrumbs", scale: 0.6, done: true },
			{ name: "Command", slug: "command", href: "/docs/components/command", scale: 0.7, done: true },
		],
	},
	{
		title: "Data display",
