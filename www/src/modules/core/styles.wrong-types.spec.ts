...
const fixtureMeta = {
	...
	params: {
		style: { kind: "enum", default: "default", values: ["default", "alt"] as const },
		highlight: { kind: "enum", default: "subtle", values: ["subtle", "accent"] as const },
		radius: { kind: "scalar", type: "radius", cssVar: "--fixture-radius", default: "--radius-md" },
	},
...
createStyles(fixtureMeta, {
	...
	params: {
		style: {
			...
			alt: { slots: { item: "italic" }, vars: { "--fixture-bg": "var(--neutral-100)" } },
		},
		highlight: {
...
const _badCssVar = {
	...
	params: {
		...
		radius: { kind: "scalar", type: "radius", cssVar: "alert-radius", default: "--radius-md" },
	},
} satisfies RegistryItem;
