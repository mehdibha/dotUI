  ...
  return (
    <div>
      ...
      {/* <div className="overflow-hidden">
        <section className="container relative max-w-2xl pt-20 sm:pb-32 sm:pt-20">
          <div className="size-150 absolute -top-5 left-1/2 z-[-1] max-w-[80%] -translate-x-[calc(50%-200px)] rounded-md bg-[radial-gradient(at_0%_0%,#0894ff_0,rgba(0,0,0,0)_40%),radial-gradient(at_50%_30%,#ff2e54_0,rgba(0,0,0,0)_60%),radial-gradient(at_100%_0%,#ff9004_0,rgba(0,0,0,0)_40%)] opacity-5 blur-[70px] ease-in-out dark:blur-[50px]" />

          <h2 className="text-pretty text-2xl font-extrabold tracking-tighter sm:font-medium lg:text-3xl xl:text-4xl">
            Bringing <span className="text-fg-muted">singularity</span> to the
            web.
          </h2>
          <h2 className="text-pretty text-right text-2xl font-medium tracking-tighter sm:font-normal lg:text-3xl xl:text-4xl">
            Fueled by your <span className="text-fg-muted italic">stars</span>.
          </h2>
          <p className="text-fg-muted mt-2 text-base">
            Our contributors are working hard to make the web a more singular
            place.
          </p>
          <div className="max-xs:flex-col mt-6 flex items-center justify-between gap-6 pl-8 sm:items-end sm:justify-between sm:gap-10 lg:gap-20">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="bg-bg-inverse/5 rounded-xs h-12"
            >
              Star on GitHub
            </Button>
          </div>
