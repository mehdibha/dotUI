...
export function ThemeColors({ style }: { style: Style }) {
  ...
  return (
    <div>
      ...
      <div className="[&_[data-slot=label]]:!text-neutral-600 dark:[&_[data-slot=label]]:!text-neutral-400">
        <CurrentStyleProvider className="bg-transparent">
          <p data-slot="label" className="mt-2 font-medium tracking-tight">
            Core colors
          </p>
          <Collapsible show={isEditMode}>
            <div className="py-1">
          ...
          <div className="mt-1 space-y-1">
            {[
              ...
              <div key={shade.name} className="flex items-center gap-2">
                <p data-slot="label" className="text-fg-muted w-[60px] text-sm">
                  {shade.label}
                </p>
...
function ColorItem({
  ...
  return (
    <Skeleton
      show={isLoading}
      className={cn(
        "relative h-12 flex-1 not-first:-ml-4 not-last:-mr-4",
        containerClassName
      )}
    >
      <button
      ...
      >
        <div
          className={cn(
            ...
            hoverAnimation &&
              "transition-[height] duration-250 ease-out hover:h-22",
            className
          )}
          style={style}
        >
          ...
          <div
            className={cn(
              "absolute top-1/2 left-1/2 flex -translate-x-1/2 -translate-y-1/2 items-center gap-2 opacity-0 transition-opacity",
                    ...
                    <AnimatePresence>
                      <span className="relative">
                        <motion.span
                          ...
                          className="bg-bg-muted absolute top-0 left-1/2 -translate-x-1/2 -translate-y-[calc(100%+10px)] rounded-sm border p-2"
                        >
                          {state.values[i]}
                        </motion.span>
                      </span>
