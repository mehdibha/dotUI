...
const tabsStyles = tv({
  slots: {
    ...
    tab: [
      focusRing(),
      "text-fg-muted hover:text-fg selected:not-disabled:text-fg disabled:text-fg-disabled flex cursor-pointer items-center justify-center whitespace-nowrap text-sm transition-colors disabled:cursor-default",
    ],
    panel: focusRing(),
  },
  variants: {
