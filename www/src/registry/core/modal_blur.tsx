...
const modalStyles = tv({
  slots: {
    underlay:
      "h-(--visual-viewport-height) exiting:opacity-0 entering:opacity-0 bg-bg-inverse/40 dark:bg-bg/40 backdrop-blur-xs fixed left-0 top-0 z-50 flex w-screen items-center justify-center opacity-100 duration-200 ease-[cubic-bezier(0.165,0.84,0.44,1)] will-change-[opacity]",
    overlay:
