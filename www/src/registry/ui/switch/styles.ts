...
const { useStyles, styles } = createStyles(switchMeta, {
	base: {
		slots: {
			...
			thumb: "pointer-events-none block origin-right rounded-full bg-white shadow-lg ring-0 transition-all duration-200 group-disabled:bg-fg-disabled",
		},
		variants: {
			variant: {
				default: {
			...
			size: {
				sm: {
					indicator: "h-5 w-9",
					thumb: "size-4 group-selected/switch:group-pressed/switch:ml-3 group-selected/switch:ml-4 group-pressed/switch:w-5",
				},
				md: {
					indicator: "h-6 w-11",
					thumb: "size-5 group-selected/switch:group-pressed/switch:ml-4 group-selected/switch:ml-5 group-pressed/switch:w-6",
				},
				lg: {
					indicator: "h-7 w-13",
					thumb: "size-6 group-selected/switch:group-pressed/switch:ml-5 group-selected/switch:ml-6 group-pressed/switch:w-7",
				},
			},
		},
		defaultVariants: {
