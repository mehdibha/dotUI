...
const { useStyles, styles } = createStyles(menuMeta, {
  base: {
    slots: {
      ...
      item: [
        "relative flex w-full cursor-interactive items-center gap-2 rounded-(--menu-item-radius) outline-hidden select-ui disabled:pointer-events-none **:[svg]:pointer-events-none **:[svg]:shrink-0",
