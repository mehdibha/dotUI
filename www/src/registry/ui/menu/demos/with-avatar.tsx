import { BellIcon, ChevronsUpDownIcon, CreditCardIcon, LogOutIcon, UserIcon } from "@/registry/__generated__/icons";
...
export default function Demo() {
	return (
		<div className="flex w-full items-center justify-between gap-4">
			<Menu>
				<Button variant="default" className="h-12 justify-start gap-2 px-2 md:max-w-[200px]">
					<Avatar size="sm">
