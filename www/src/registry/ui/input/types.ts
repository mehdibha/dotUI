 ...
 */
export interface InputGroupProps extends React.ComponentProps<
 ...
 */
export interface TextAreaProps extends React.ComponentProps<
  typeof TextAreaPrimitives.TextArea
> {}
 ...
 */
export interface DateSegmentProps extends React.ComponentProps<
  typeof DateFieldPrimitives.DateSegment
> {}
