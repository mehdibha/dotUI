 ...
 */
export interface TableColumnProps extends React.ComponentProps<
...
export interface TableRowProps<
  T extends object,
> extends TablePrimitives.RowProps<T> {}

/**
 * A cell within a table row.
 */
export interface TableCellProps extends React.ComponentProps<
 ...
 */
export interface TableLoadMoreProps extends React.ComponentProps<
