...
export interface BreadcrumbsProps<
  T extends object,
> extends BreadcrumbsPrimitives.BreadcrumbsProps<T> {
 ...
 */
export interface BreadcrumbItemProps extends React.ComponentProps<
  typeof BreadcrumbsPrimitives.Breadcrumb
> {}

/**
 * A link allows a user to navigate to another page or resource within a web page or application.
 */
export interface BreadcrumbLinkProps extends React.ComponentProps<
