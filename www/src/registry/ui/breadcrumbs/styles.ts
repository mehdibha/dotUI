  ...
  base: {
    slots: {
      ...
      link: [
        ...
        "inline-flex items-center gap-1 rounded px-0.5 leading-none transition-colors disabled:cursor-disabled disabled:not-current:text-fg-disabled current:text-fg",
      ],
