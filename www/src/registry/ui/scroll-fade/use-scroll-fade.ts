...
function updateOverflowState(element: HTMLElement) {
	...
	setBooleanAttribute(element, "data-overflow-x-start", hasOverflowX && scrollLeftFromStart > OVERFLOW_EDGE_THRESHOLD);
...
function observeScrollFadeResizeTargets(resizeObserver: ResizeObserver, element: HTMLElement) {
