...
const baseStyles = tv({
	slots: {
		...
		cell: [
			...
			"in-data-range-calendar:not-outside-month:selected:bg-accent/20 selection-end:rounded-r-full selection-start:rounded-l-full",
			// range radius
			...
			// single mode
			"focus-reset in-data-calendar:focus-visible:focus-ring in-data-calendar:rounded-(--cell-radius) in-data-calendar:selected:not-outside-month:bg-accent in-data-calendar:selected:not-outside-month:text-fg-on-accent in-data-calendar:transition-shadow in-data-calendar:hover:bg-accent/20",
		...
		cellInner:
			"focus-reset in-focus-visible:focus-ring flex in-data-calendar:contents size-full items-center justify-center rounded-(--cell-radius) in-selection-end:not-in-outside-month:bg-accent in-selection-start:not-in-outside-month:bg-accent in-selection-end:not-in-outside-month:text-fg-on-accent in-selection-start:not-in-outside-month:text-fg-on-accent transition-shadow not-in-selection-start:not-in-selection-end:hover:bg-accent/20",
	},
});
