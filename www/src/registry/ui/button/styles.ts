  ...
  base: {
    ...
    variants: {
      variant: {
        ...
        secondary:
          "border bg-neutral text-fg-on-neutral disabled:border-(--disabled-border,var(--color-border-control)) disabled:bg-(--disabled-bg,var(--color-neutral)) disabled:text-(--disabled-fg,var(--color-fg-on-neutral)) pending:border-border",
        quiet:
    ...
    compact: {
      ...
      variants: {
        size: {
          ...
          xl: "h-9 px-3 text-sm has-data-[icon=inline-end]:pr-2.5 has-data-[icon=inline-start]:pl-2.5 data-icon-only:size-9 **:[svg]:not-with-[size]:size-4",
        },
      },
    },
    default: {
    ...
    comfortable: {
      ...
      variants: {
        size: {
          ...
          xl: "h-11 gap-2 px-4 text-base has-data-[icon=inline-end]:pr-3 has-data-[icon=inline-start]:pl-3 data-icon-only:size-11 **:[svg]:not-with-[size]:size-5",
        },
      },
    },
  },
