	...
	base: {
		slots: {
			root: [
				...
				"layout-grid:grid layout-grid:grid-cols-2 layout-grid:gap-1",
			],
			item: [
				...
				// focus
				"focus:in-data-[:is([data-trigger=ComboBox],[data-trigger=Select])]:bg-highlight focus:in-[:is([data-trigger=ComboBox],[data-trigger=Select])]:text-fg-on-highlight",
