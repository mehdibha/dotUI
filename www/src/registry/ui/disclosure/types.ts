 ...
 */
export interface DisclosureProps extends React.ComponentProps<
 ...
 */
export interface DisclosurePanelProps extends React.ComponentProps<
 ...
 */
export interface DisclosureTriggerProps extends React.ComponentProps<
