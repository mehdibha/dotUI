 ...
 */
export interface TabsProps extends React.ComponentProps<typeof TabsPrimitives.Tabs> {}
 ...
 */
export interface TabProps extends React.ComponentProps<typeof TabsPrimitives.Tab> {}

/**
 * A TabPanel provides the content for a tab.
 */
export interface TabPanelProps extends React.ComponentProps<typeof TabsPrimitives.TabPanel> {}
