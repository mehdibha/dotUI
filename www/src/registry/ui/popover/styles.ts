...
const { useStyles, styles } = createStyles(popoverMeta, {
	base: {
		slots: {
			popover: [
				"popover z-50 min-w-[max(var(--trigger-width),--spacing(32))] max-w-72 origin-(--trigger-anchor-point) overflow-y-auto rounded-(--popover-radius) border bg-popover shadow-md forced-color-adjust-none",
