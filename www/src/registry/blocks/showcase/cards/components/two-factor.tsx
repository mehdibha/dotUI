	...
	return (
		<Card className={cn("", className)} {...props}>
			<CardHeader>
				...
				<CardDescription>Enter the 6-digit code we sent to your phone.</CardDescription>
			</CardHeader>
			<CardContent>
				<OTPField length={6} defaultValue="029" aria-label="Verification code" className="items-center">
