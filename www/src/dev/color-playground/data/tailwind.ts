...
/** Tailwind CSS v4 default palette (from the `tailwindcss` npm package, ported via `dcdd548b`). */
export const tailwind: ReferenceSource = {
  id: 'tailwind',
  label: 'Tailwind v4',
  ...
  dark: [],
  notes: 'Tailwind ships a single fixed palette — no dark ramps.',
}
