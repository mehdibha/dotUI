...
const modalStyles = tv({
  slots: {
    underlay:
      "exiting:opacity-0 entering:opacity-0 bg-bg-inverse/40 dark:bg-bg/40 fixed top-0 left-0 z-50 flex h-(--visual-viewport-height) w-screen items-center justify-center opacity-100 duration-200 ease-[cubic-bezier(0.165,0.84,0.44,1)] will-change-[opacity]",
    overlay:
