...
const toHex = (color: { toString: (format: 'hex') => string }) =>
  color.toString('hex').toLowerCase()
    ...
    >
      ...
      <div className="flex shrink-0 items-center gap-7">
        <ControlField>
          ...
          <AccentPicker
            className="shrink-0 min-[440px]:hidden"
            accent={accent}
        ...
        <ControlField>
          ...
          <RadiusPopover
            className="shrink-0 min-[560px]:hidden"
            radius={radius}
            onRadiusChange={onRadiusChange}
          />
        </ControlField>
        ...
        <ControlField>
          ...
          <DensitySelect
            className="shrink-0 min-[700px]:hidden"
            density={density}
  ...
  return (
    <div className={className}>
      <Select
        aria-label="Density"
        selectedKey={density}
        onSelectionChange={(key) => onDensityChange(key as Density)}
      >
