 ...
 */
export function buildTypeAstFromString(
  typeString: string,
...
export function typeToAst(
  ...
  // This is how we prevent ReactNode from being expanded into a huge union.
  // ============================================================================
  const aliasSymbol = type.aliasSymbol;
  if (aliasSymbol) {
    const aliasName = aliasSymbol.getName();

    // Never expand these types - return as simple identifier
 ...
 */
function functionSignatureToAst(
