		...
		<div className="space-y-4">
			{(["sm", "md", "lg"] as const).map((size) => (
				<div key={size} className="flex flex-wrap items-center gap-4">
					...
					<ToggleButtonGroup variant="quiet" size={size} disallowEmptySelection defaultSelectedKeys={["all"]}>
						<ToggleButton id="all">All</ToggleButton>
						<ToggleButton id="missed">Missed</ToggleButton>
					</ToggleButtonGroup>
					<ToggleButtonGroup size={size} disallowEmptySelection defaultSelectedKeys={["all"]}>
			...
			<div className="flex gap-8">
				{(["sm", "md", "lg"] as const).map((size) => (
					<div key={size} className="flex gap-2">
						<ToggleButtonGroup orientation="vertical" variant="default" size={size}>
							<ToggleButton defaultSelected>
								<BoldIcon />
							</ToggleButton>
							<ToggleButton>
						...
						<ToggleButtonGroup orientation="vertical" variant="quiet" size={size}>
							<ToggleButton defaultSelected>
								<BoldIcon />
							</ToggleButton>
							<ToggleButton>
