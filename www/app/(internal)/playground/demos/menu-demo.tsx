...
import { Menu, MenuContent, MenuItem, MenuSection, MenuSectionHeader, MenuSub } from "@dotui/registry/ui/menu";
		...
		<div className="flex flex-wrap gap-4">
			...
			<Menu>
				<Button className="h-12 justify-start px-2 md:max-w-[230px]">
					<Avatar src="https://github.com/mehdibha.png" alt="mehdibha" fallback="M" className="size-7" />
					<div className="grid flex-1 text-left text-sm leading-tight">
						<span className="truncate font-semibold">mehdibha</span>
						<span className="truncate text-muted-foreground text-xs">mehdibha@example.com</span>
					</div>
