...
function ComponentCard({ name, href, preview, scale = 0.8, className, previewClassName }: ComponentCardProps) {
	return (
		<div className={cn("flex flex-col items-center", className)}>
			<div className={cn("h-32 overflow-hidden rounded-lg border bg-muted", previewClassName)}>
				<iframe
					src={preview}
