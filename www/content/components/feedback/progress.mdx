...
<ComponentPreview
  name="core/progress-value-label"
...
<ComponentPreview
  name="core/progress-format-options"
  preview={`<Progress
  label="Sending…"
  showValueLabel
...
<ComponentPreview name="core/progress-custom-value-label" preview={``} />

### Indeterminate

The `isIndeterminate` prop can be used to represent an interdeterminate operation.

<ComponentPreview name="core/progress-indeterminate" preview={``} />
...
<ComponentPreview name="core/progress-min-max-values" preview={``} />
...
<ComponentPreview name="core/progress-composition" preview={``} />

### Custom color

<ComponentPreview name="core/progress-custom-color" preview={``} />

### Toolbar

<ComponentPreview name="core/progress-toolbar" preview={``} />
