...
<ComponentPreview name="core/date-field-default" preview={`<DateField />`} />
...
<ComponentPreview
  name="core/date-field-prefix-and-suffix"
...
<ComponentPreview
  name="core/date-field-description"
...
<ComponentPreview
  name="core/date-field-contextual-help"
  preview={`<DateField
  label="Appointment"
...
<ComponentPreview
  name="core/date-field-error-message"
  preview={`<DateField
  label="Meeting"
  isInvalid
...
<ComponentPreview
  name="core/date-field-time-zones"
...
<ComponentPreview
  name="core/date-field-granularity"
  preview={`<DateField
  label="Hour"
  granularity="hour"
...
<ComponentPreview
  name="core/date-field-placeholder"
...
<ComponentPreview
  name="core/date-field-hide-time-zone"
  preview={`<DateField
...
<ComponentPreview
  name="core/date-field-hour-cycle"
...
<ComponentPreview
  name="core/date-field-read-only"
...
<ComponentPreview
  name="core/date-field-uncontrolled"
...
<ComponentPreview
  name="core/date-field-controlled"
...
<ComponentPreview name="core/date-field-composition" preview={``} />
