...
import {
  SkeletonPlayground,
  skeletonControls,
} from "@dotui/registry/ui/skeleton/playground";
...
<PageTabs>
  <PageTabPanel id="overview">
    ...
    <InteractiveDemo component={SkeletonPlayground} controls={skeletonControls} />
    ...
    | Prop        | Type        | Default | Description                              |
    | ----------- | ----------- | ------- | ---------------------------------------- |
    | `className` | `string`    | -       | Custom CSS classes for the skeleton.     |
