...
<Demo name="calendar/demos/range-calendar/default" />
...
<Demo name="calendar/demos/range-calendar/uncontrolled" />

## Controlled

The Range Calendar component can be controlled by passing the `value` and `onChange` props.

<Demo name="calendar/demos/range-calendar/controlled" />
...
<Demo name="calendar/demos/range-calendar/validation" />
...
<Demo name="calendar/demos/range-calendar/unvailable-dates" />
...
<Demo name="calendar/demos/range-calendar/non-contiguous-ranges" />
...
<Demo name="calendar/demos/range-calendar/error-message" />
...
<Demo name="calendar/demos/range-calendar/read-only" />

## Composition

If you need to customize things further, you can drop down to the composition level.

<Demo name="calendar/demos/range-calendar/composition" />
