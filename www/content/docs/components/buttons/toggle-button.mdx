...
<ComponentPreview
  name="core/toggle-button/toggle-button-default"
...
```
  ...
  <Tab value="manual">
    ...
    ```
      ...
      <ComponentSource name="core/toggle-button/toggle-button" />
...
<ComponentPreview
  name="core/toggle-button/toggle-button-variants"
...
<ComponentPreview
  name="core/toggle-button/toggle-button-sizes"
...
<ComponentPreview
  name="core/toggle-button/toggle-button-shapes"
...
<ComponentPreview
  name="core/toggle-button/toggle-button-disabled"
...
<ComponentPreview
  name="core/toggle-button/toggle-button-uncontrolled"
...
<ComponentPreview
  name="core/toggle-button/toggle-button-controlled"
