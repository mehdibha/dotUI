...
Use `Input` to allow users to enter text. Combine with `InputGroup` and `InputAddon` to add icons, buttons, or labels alongside the input.
...
<Examples>
  ...
  <Example name="input/demos/sizes" title="Sizes" />
