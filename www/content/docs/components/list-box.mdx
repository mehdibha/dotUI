...
```package-install
npx shadcn@latest add https://dotui.org/r/{{STYLE_NAME}}/list-box.json
```
...
<ComponentPreview
  name="list-box/demos/horizontal"
...
<ComponentPreview
  name="list-box/demos/selection-mode"
...
<ComponentPreview
  name="list-box/demos/selection-behavior"
...
<ComponentPreview
  name="list-box/demos/empty-state"
...
<ComponentPreview
  name="list-box/demos/item-variant"
  preview={`<ListBox>
    <Item>View logs</Item>
...
<ComponentPreview
  name="list-box/demos/label-and-description"
  preview={`<ListBox>
    <Item textValue="Read" label="Read" description="Read Only" />
    <Item textValue="Write" label="Write" description="Read and Write Only" />
    <Item textValue="Admin" label="Admin" description="Full access" />
...
<ComponentPreview
  name="list-box/demos/prefix-and-suffix"
  preview={`<ListBox>
...
<ComponentPreview
  name="list-box/demos/disabled-items"
  preview={`<ListBox>
    <Item>Next.js</Item>
    <Item>Remix</Item>
...
<ComponentPreview
  name="list-box/demos/uncontrolled"
  preview={`<ListBox
...
<ComponentPreview
  name="list-box/demos/controlled"
...
<ComponentPreview
  name="list-box/demos/composition"
  preview={`<ListBox selectionMode="multiple">
    <Item>
...
<ComponentPreview 
  name="list-box/demos/async-loading"
