...
<Demo name="progress-bar/demos/format-options" />

### Custom value label

The `valueLabel` prop allows the formatted value to be replaced with a custom string.

<Demo name="progress-bar/demos/custom-value-label" />
...
<Demo name="progress-bar/demos/min-max-values" />

### Indeterminate

The `isIndeterminate` prop can be used to represent an interdeterminate operation.

<Demo name="progress-bar/demos/indeterminate" />
...
<Demo name="progress-bar/demos/duration" />

## Composition

If you need to customize things further, you can drop down to the composition level.

<Demo name="progress-bar/demos/composition" />
