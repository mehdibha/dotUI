...
<Demo name="color-picker/demos/uncontrolled" />

## Controlled

Use the `value` and `onChange` props to control the color picker value.

<Demo name="color-picker/demos/controlled" />
...
<Demo name="color-picker/demos/channel-sliders" />
...
<Demo name="color-picker/demos/swatches" />
