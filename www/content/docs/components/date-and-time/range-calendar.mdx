...
<ComponentPreview
  name="calendar/range-calendar/default"
...
<ComponentPreview
  name="calendar/range-calendar/uncontrolled"
...
<ComponentPreview
  name="calendar/range-calendar/controlled"
...
<ComponentPreview
  name="calendar/range-calendar/validation"
...
<ComponentPreview
  name="calendar/range-calendar/unvailable-dates"
...
<ComponentPreview
  name="calendar/range-calendar/non-contiguous-ranges"
  preview={`const now = today(getLocalTimeZone());
  const disabledRanges = [
    [now, now.add({ days: 5 })],
    [now.add({ days: 14 }), now.add({ days: 16 })],
...
<ComponentPreview
  name="calendar/range-calendar/error-message"
...
<ComponentPreview
  name="calendar/range-calendar/visible-months"
...
<ComponentPreview
  name="calendar/range-calendar/page-behaviour"
...
<ComponentPreview
  name="calendar/range-calendar/disabled"
...
<ComponentPreview
  name="calendar/range-calendar/read-only"
  preview={`<RangeCalendar
    aria-label="Trip dates"
    isReadOnly
    value={{
...
<ComponentPreview
  suspense
  name="calendar/range-calendar/composition"
