...
<ComponentPreview
  name="core/date-range-picker/date-range-picker-default"
...
```
  ...
  <Tab value="manual">
    ...
    ```
      ...
      <ComponentSource name="core/date-range-picker/date-range-picker" />
...
<ComponentPreview
  name="core/date-range-picker/date-range-picker-label"
...
<ComponentPreview
  name="core/date-range-picker/date-range-picker-sizes"
...
<ComponentPreview
  name="core/date-range-picker/date-range-picker-prefix"
...
<ComponentPreview
  name="core/date-range-picker/date-range-picker-description"
...
<ComponentPreview
  name="core/date-range-picker/date-range-picker-contextual-help"
...
<ComponentPreview
  name="core/date-range-picker/date-range-picker-error-message"
  preview={`<DateRangePicker
    label="Trip dates"
    isInvalid
...
<ComponentPreview
  name="core/date-range-picker/date-range-picker-time-zones"
  preview={`<DateRangePicker
    defaultValue={{
...
<ComponentPreview
  name="core/date-range-picker/date-range-picker-granularity"
...
<ComponentPreview
  name="core/date-range-picker/date-range-picker-placeholder"
...
<ComponentPreview
  name="core/date-range-picker/date-range-picker-hide-time-zone"
  preview={`<DateRangePicker
...
<ComponentPreview
  name="core/date-range-picker/date-range-picker-hour-cycle"
...
<ComponentPreview
  name="core/date-range-picker/date-range-picker-loading"
...
<ComponentPreview
  name="core/date-range-picker/date-range-picker-disabled"
...
<ComponentPreview
  name="core/date-range-picker/date-range-picker-read-only"
  preview={`<DateRangePicker
    label="Event date"
    value={{
      start: parseAbsoluteToLocal("2021-04-07T18:45:22Z"),
...
<ComponentPreview
  name="core/date-range-picker/date-range-picker-required"
...
<ComponentPreview
  name="core/date-range-picker/date-range-picker-uncontrolled"
  preview={`<DateRangePicker
  label="Controlled"
  defaultValue={{
...
<ComponentPreview
  name="core/date-range-picker/date-range-picker-controlled"
...
<ComponentPreview
  name="core/date-range-picker/date-range-picker-composition"
