...
```tsx
<Sparkline data={data} x="day" y="visitors" mode="area" fill="gradient" />
```
...
```tsx
<Sparkline data={data} x="day" y="visitors" tooltip />
```
...
<Sparkline data={data} x="day" y="visitors" marksBefore={average} marks={latest} />
```
