...
`layout="bar"` on `DialogHeader` centers the title between a leading and a trailing action — the navigation bar of an iOS sheet. Close buttons take `slot="close"`.

<Demo name="dialog/demos/header-bar" />
