...
<Tabs items={["CLI", "Manual"]}>
  ...
  ```package-install
npx dotui@latest add breadcrumbs
```
  ...
  <Tab value="manual">
    ...
    ```
      ...
      <ComponentSource name="core/breadcrumbs" />
...
<ComponentPreview
  name="core/breadcrumbs-disabled"
...
<ComponentPreview
  name="core/breadcrumbs-composition"
  preview={`<Breadcrumbs>
    <BreadcrumbItem>
...
<ComponentPreview
  name="core/breadcrumbs-router-integration"
