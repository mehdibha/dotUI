...
<ComponentPreview
  name="core/breadcrumbs/breadcrumbs-basic"
  preview={`<Breadcrumbs>
...
```
  ...
  <Tab value="manual">
    ...
    ```
      ...
      <ComponentSource name="core/breadcrumbs/breadcrumbs" />
...
<ComponentPreview
  name="core/breadcrumbs/breadcrumbs-disabled"
...
<ComponentPreview
  name="core/breadcrumbs/breadcrumbs-composition"
  preview={`<Breadcrumbs>
    <BreadcrumbItem>
...
<ComponentPreview
  name="core/breadcrumbs/breadcrumbs-icon"
  preview={`<Breadcrumbs>
    <Breadcrumb href="#">
      <HomeIcon />
      Home
...
<ComponentPreview
  name="core/breadcrumbs/breadcrumbs-router-integration"
