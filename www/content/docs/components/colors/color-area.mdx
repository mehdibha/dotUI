...
```
  ...
  <Tab value="manual">
    ...
    ```
      ...
      <ComponentSource name={["core/color-area/color-area"]} />
...
<ComponentPreview
  name="core/color-area/color-area-channels"
...
<ComponentPreview
  name="core/color-area/color-area-disabled"
...
<ComponentPreview
  name="core/color-area/color-area-uncontrolled"
...
<ComponentPreview
  name="core/color-area/color-area-controlled"
...
<ComponentPreview
  name="core/color-area/color-area-composition"
