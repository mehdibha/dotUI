...
<ComponentPreview
  name="color-field/demos/default"
...
```package-install
npx shadcn@latest add https://dotui.org/r/{{STYLE_NAME}}/color-field.json
```
...
<ComponentPreview
  name="color-field/demos/controlled"
...
<ComponentPreview
  name="color-field/demos/description"
...
<ComponentPreview
  name="color-field/demos/error-message"
...
<ComponentPreview
  name="color-field/demos/prefix-and-suffix"
...
<ComponentPreview
  name="color-field/demos/disabled"
...
<ComponentPreview
  name="color-field/demos/read-only"
...
<ComponentPreview
  name="color-field/demos/required"
...
<ComponentPreview
  name="color-field/demos/composition"
