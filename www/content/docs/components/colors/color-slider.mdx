...
<ComponentPreview
  name="core/color-slider-default"
...
<Tabs items={["CLI", "Manual"]}>
  ...
  ```package-install
npx dotui@latest add color-slider
```
  ...
  <Tab value="manual">
    ...
    ```
      ...
      <ComponentSource name={["core/color-slider"]} />
...
<ComponentPreview
  name="core/color-slider-vertical"
...
<ComponentPreview
  name="core/color-slider-channel"
...
<ComponentPreview
  name="core/color-slider-disabled"
...
<ComponentPreview
  name="core/color-slider-uncontrolled"
...
<ComponentPreview
  name="core/color-slider-controlled"
