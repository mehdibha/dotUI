...
<Alert><span className="font-bold">Note:</span> Modal only provides the overlay itself. It should be combined with Dialog to create fully accessible modal dialogs. [See dialog](/docs/components/overlays/dialog) component instead.</Alert>
