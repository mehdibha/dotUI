...
<ComponentPreview
  name="core/date-range-picker-hide-time-zone"
  preview={`<DateRangePicker
...
<ComponentPreview
  name="core/date-range-picker-hour-cycle"
...
<ComponentPreview
  name="core/date-range-picker-loading"
...
<ComponentPreview
  name="core/date-range-picker-disabled"
...
<ComponentPreview
  name="core/date-range-picker-read-only"
  preview={`<DateRangePicker
    label="Event date"
    value={{
      start: parseAbsoluteToLocal("2021-04-07T18:45:22Z"),
...
<ComponentPreview
  name="core/date-range-picker-required"
...
<ComponentPreview
  name="core/date-range-picker-uncontrolled"
  preview={`<DateRangePicker
  label="Controlled"
  defaultValue={{
...
<ComponentPreview
  name="core/date-range-picker-controlled"
...
<ComponentPreview
  name="core/date-range-picker-composition"
