...
<ComponentPreview name="core/date-picker-default" preview={`<DatePicker />`} />
...
<ComponentPreview
  name="core/date-picker-description"
...
<ComponentPreview
  name="core/date-picker-contextual-help"
...
<ComponentPreview
  name="core/date-picker-error-message"
  preview={`<DatePicker
  label="Meeting"
  isInvalid
...
<ComponentPreview
  name="core/date-picker-time-zones"
...
<ComponentPreview
  name="core/date-picker-granularity"
  preview={`<DatePicker
  label="Hour"
  granularity="hour"
...
<ComponentPreview
  name="core/date-picker-placeholder"
...
<ComponentPreview
  name="core/date-picker-hide-time-zone"
  preview={`<DatePicker
...
<ComponentPreview
  name="core/date-picker-hour-cycle"
...
<ComponentPreview
  name="core/date-picker-disabled"
...
<ComponentPreview
  name="core/date-picker-read-only"
...
<ComponentPreview
  name="core/date-picker-required"
...
<ComponentPreview
  name="core/date-picker-uncontrolled"
...
<ComponentPreview
  name="core/date-picker-controlled"
...
<ComponentPreview
  name="core/date-picker-composition"
