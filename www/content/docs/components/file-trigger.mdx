...
<Demo name="file-trigger/demos/file-types" />

## Multiple files

A file trigger can accept multiple files by passsing the `allowsMultiple` prop.

<Demo name="file-trigger/demos/multiple-files" />
...
<Demo name="file-trigger/demos/directory-selection" />
...
<Demo name="file-trigger/demos/media-capture" />
