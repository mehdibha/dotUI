...
<Demo name="date-range-picker/demos/default" />

## Installation

```npm
npx shadcn@latest add @dotui/date-range-picker
```
...
<Demo name="date-range-picker/demos/label" />
...
<Demo name="date-range-picker/demos/sizes" />

### Prefix

To add additional context for the `DateRangePicker`, use the `prefix` prop.

<Demo name="date-range-picker/demos/prefix" />
...
<Demo name="date-range-picker/demos/read-only" />
