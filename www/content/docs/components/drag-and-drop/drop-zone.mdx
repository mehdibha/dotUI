...
<Tabs items={["CLI", "Manual"]}>
  ...
  ```package-install
npx dotui@latest add drop-zone
```
  ...
  <Tab value="manual">
    ...
    ```
      ...
      <ComponentSource name="core/drop-zone" />
...
<ComponentPreview
  name="core/drop-zone-file-trigger"
  preview={`<DropZone>
    <UploadIcon />
    <Text slot="label">Drag and drop files here</Text>
    <FileTrigger>
