...
```
  ...
  <Tab value="manual">
    ...
    <Steps>
      ...
      <ComponentSource name="core/skeleton" />
...
<ComponentPreview name="core/skeleton-children" />

## Show

Use the `show` prop to show/hide the skeleton.

<ComponentPreview name="core/skeleton-show" />

## Examples

### Loading data from an API

<ComponentPreview name="core/skeleton-api-simulation" />

### Wrapping children with fixed size

If you do not pass a fixed size, it will be calculated automatically.

<ComponentPreview name="core/skeleton-fixed-size-children" />
