...
<ComponentPreview
  name="core/progress-bar/progress-bar-default"
...
<ComponentPreview
  name="core/progress-bar/progress-bar-variants"
...
<ComponentPreview
  name="core/progress-bar/progress-bar-sizes"
...
<ComponentPreview
  name="core/progress-bar/progress-bar-label"
...
<ComponentPreview
  name="core/progress-bar/progress-bar-value-label"
...
<ComponentPreview
  name="core/progress-bar/progress-bar-format-options"
  preview={`<Progress
    label="Sending…"
    showValueLabel
...
<ComponentPreview
  name="core/progress-bar/progress-bar-custom-value-label"
  preview={`<Progress
    label="Feeding…"
    showValueLabel
...
<ComponentPreview
  name="core/progress-bar/progress-bar-min-max-values"
  preview={`<Progress
...
<ComponentPreview
  name="core/progress-bar/progress-bar-indeterminate"
...
<ComponentPreview
  name="core/progress-bar/progress-bar-duration"
...
<ComponentPreview
  name="core/progress-bar/progress-bar-composition"
