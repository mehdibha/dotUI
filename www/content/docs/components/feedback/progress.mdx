...
<ComponentPreview
  name="core/progress-custom-value-label"
  preview={`<Progress
    label="Feeding…"
    showValueLabel
...
<ComponentPreview
  name="core/progress-indeterminate"
...
<ComponentPreview
  name="core/progress-min-max-values"
  preview={`<Progress
...
<ComponentPreview
  name="core/progress-composition"
...
<ComponentPreview
  name="core/progress-custom-color"
  preview={`<Progress
    value={75}
