...
<ComponentPreview
  name="core/progress/progress-default"
...
```
  ...
  <Tab value="manual">
    ...
    ```
      ...
      <ComponentSource name="core/progress/progress" />
...
<ComponentPreview
  name="core/progress/progress-variants"
...
<ComponentPreview
  name="core/progress/progress-sizes"
...
<ComponentPreview
  name="core/progress/progress-label"
...
<ComponentPreview
  name="core/progress/progress-value-label"
...
<ComponentPreview
  name="core/progress/progress-format-options"
  preview={`<Progress
    label="Sending…"
    showValueLabel
...
<ComponentPreview
  name="core/progress/progress-custom-value-label"
  preview={`<Progress
    label="Feeding…"
    showValueLabel
...
<ComponentPreview
  name="core/progress/progress-indeterminate"
  preview={`<Progress isIndeterminate aria-label="Loading" />`}
/>
...
<ComponentPreview
  name="core/progress/progress-duration"
...
<ComponentPreview
  name="core/progress/progress-min-max-values"
  preview={`<Progress
...
<ComponentPreview
  name="core/progress/progress-composition"
  preview={`<ProgressRoot value={50} className="flex-row items-center gap-4">
...
<ComponentPreview
  name="core/progress/progress-custom-color"
  preview={`<Progress
    value={75}
...
<ComponentPreview name="core/progress/progress-toolbar" preview={``} />
