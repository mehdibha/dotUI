...
<Tabs items={["CLI", "Manual"]}>
  ...
  ```package-install
npx dotui@latest add scroll-area
```
  ...
  <Tab value="manual">
    ...
    ```
      ...
      <ComponentSource name="core/scroll-area" />
...
<ComponentPreview
  name="core/scroll-area-scrollbars"
  preview={`<div className="rounded-md border p-6">
  <ScrollArea
