...
Menus open on press by default. Set `trigger="longPress"` when press is reserved for a primary action — the menu then opens on long press (or <kbd>Alt</kbd> + <kbd>▼</kbd>):
...
<Demo name="menu/demos/context-menu" />
