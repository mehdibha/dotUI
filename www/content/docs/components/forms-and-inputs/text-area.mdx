...
```package-install
npx shadcn@latest add https://dotui.org/r/{style-name}/text-area.json
```
...
<ComponentPreview
  name="text-area/demos/description"
...
<ComponentPreview
  name="text-area/demos/error-message"
  preview={`<TextArea 
    label="Comment"
    isInvalid
...
<ComponentPreview
  name="text-area/demos/prefix-and-suffix"
  preview={`<TextArea
    label="Comment"
...
<ComponentPreview
  name="text-area/demos/read-only"
...
<ComponentPreview
  name="text-area/demos/uncontrolled"
...
<ComponentPreview
  name="text-area/demos/controlled"
...
<ComponentPreview
  name="text-area/demos/composition"
