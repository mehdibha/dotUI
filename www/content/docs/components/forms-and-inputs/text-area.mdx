...
<ComponentPreview
  name="core/text-area/text-area-default"
...
```
  ...
  <Tab value="manual">
    ...
    ```
      ...
      <ComponentSource name="core/text-area/text-area" />
...
<ComponentPreview
  name="core/text-area/text-area-prefix-and-suffix"
  preview={`<TextArea
    label="Comment"
...
<ComponentPreview
  name="core/text-area/text-area-label"
...
<ComponentPreview
  name="core/text-area/text-area-description"
...
<ComponentPreview
  name="core/text-area/text-area-contextual-help"
...
<ComponentPreview
  name="core/text-area/text-area-error-message"
  preview={`<TextArea 
    label="Comment"
    isInvalid
...
<ComponentPreview
  name="core/text-area/text-area-loading"
...
<ComponentPreview
  name="core/text-area/text-area-disabled"
...
<ComponentPreview
  name="core/text-area/text-area-read-only"
...
<ComponentPreview
  name="core/text-area/text-area-required"
...
<ComponentPreview
  name="core/text-area/text-area-uncontrolled"
...
<ComponentPreview
  name="core/text-area/text-area-controlled"
...
<ComponentPreview
  name="core/text-area/text-area-composition"
