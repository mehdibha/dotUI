...
<ComponentPreview
  name="checkbox-group/demos/default"
...
```package-install
npx shadcn@latest add https://dotui.org/r/{{STYLE_NAME}}/checkbox-group.json
```
...
<ComponentPreview
  name="checkbox-group/demos/label"
  preview={`<CheckboxGroup label="React frameworks" defaultValue={["nextjs"]}>
    <Checkbox value="nextjs">Next.js</Checkbox>
    <Checkbox value="remix">Remix</Checkbox>
  </CheckboxGroup>
...
<ComponentPreview
  name="checkbox-group/demos/description"
...
<ComponentPreview
  name="checkbox-group/demos/error-message"
...
<ComponentPreview
  name="checkbox-group/demos/disabled"
...
<ComponentPreview
  name="checkbox-group/demos/read-only"
...
<ComponentPreview
  name="checkbox-group/demos/required"
...
<ComponentPreview
  name="checkbox-group/demos/uncontrolled"
  preview={`<CheckboxGroup label="React frameworks" defaultValue={["nextjs"]}>
    <Checkbox value="nextjs">Next.js</Checkbox>
    <Checkbox value="remix">Remix</Checkbox>
    <Checkbox value="gatsby">Gatsby</Checkbox>
...
<ComponentPreview
  name="checkbox-group/demos/controlled"
...
<ComponentPreview
  name="checkbox-group/demos/composition"
