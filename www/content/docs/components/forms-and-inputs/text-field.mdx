...
```package-install
npx shadcn@latest add https://dotui.org/r/{{STYLE_NAME}}/text-field.json
```
...
import { TextFieldInput, TextFieldRoot } from "@/components/core/text-field";
...
<ComponentPreview
  name="text-field/demos/description"
...
<ComponentPreview
  name="text-field/demos/error-message"
  preview={`<TextField
    label="Email"
    isInvalid
...
<ComponentPreview
  name="text-field/demos/prefix-and-suffix"
...
<ComponentPreview
  name="text-field/demos/disabled"
...
<ComponentPreview
  name="text-field/demos/read-only"
...
<ComponentPreview
  name="text-field/demos/required"
...
<ComponentPreview
  name="text-field/demos/uncontrolled"
...
<ComponentPreview
  name="text-field/demos/controlled"
...
<ComponentPreview
  name="text-field/demos/composition"
