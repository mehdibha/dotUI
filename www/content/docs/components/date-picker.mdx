...
<Demo name="date-picker/demos/label" />
...
<Demo name="date-picker/demos/sizes" />

### Prefix

To add additional context for the `DatePicker`, use the `prefix` prop.

<Demo name="date-picker/demos/prefix" />
...
<Demo name="date-picker/demos/read-only" />
