...
<Examples>
  <Example name="tree/demos/basic" description="Basic tree" />
  <Example name="tree/demos/selection" description="Multiple selection" />
  <Example name="tree/demos/with-icons" description="With icons" />
  <Example name="tree/demos/dynamic" description="Dynamic items" />
  <Example
    name="tree/demos/default-expanded"
    description="Default expanded keys"
  />
  <Example name="tree/demos/disabled" description="Disabled items" />
  <Example name="tree/demos/drag-and-drop" description="Drag and drop" />
  <Example name="tree/demos/empty" description="Empty state" />
</Examples>
