...
<Demo name="color-area/demos/disabled" />

## Composition

If you need to customize things further, you can drop down to the composition level.

<Demo name="color-area/demos/composition" />
