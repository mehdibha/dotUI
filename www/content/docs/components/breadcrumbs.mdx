...
<Demo name="breadcrumbs/demos/disabled" />

## Composition

If you need to customize things further, you can drop down to the composition level.

<Demo name="breadcrumbs/demos/composition" />

## Examples

### Icon

<Demo name="breadcrumbs/demos/icon" />

### Router integration

<Demo name="breadcrumbs/demos/router-integration" />
