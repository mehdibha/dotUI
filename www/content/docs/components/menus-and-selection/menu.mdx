...
<ComponentPreview
  name="core/menu-single-selection"
...
<ComponentPreview
  name="core/menu-multiple-selection"
  preview={`<MenuRoot>
...
<ComponentPreview
  name="core/menu-label-and-description"
  preview={`<MenuRoot>
  <Button><MenuIcon /></Button>
  <Menu>
...
<ComponentPreview
  name="core/menu-prefix-and-suffix"
  preview={`<MenuRoot>
  <Button><MenuIcon /></Button>
  <Menu>
