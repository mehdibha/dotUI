...
<ComponentPreview
  name="core/list-box-selection-mode"
...
<ComponentPreview
  name="core/list-box-selection-behavior"
...
<ComponentPreview
  name="core/list-box-empty-state"
...
<ComponentPreview
  name="core/list-box-item-variant"
  preview={`<ListBox>
  <Item>View logs</Item>
...
<ComponentPreview
  name="core/list-box-label-and-description"
  preview={`<ListBox>
  <Item textValue="Read" label="Read" description="Read Only" />
  <Item textValue="Write" label="Write" description="Read and Write Only" />
  <Item textValue="Admin" label="Admin" description="Full access" />
...
<ComponentPreview
  name="core/list-box-prefix-and-suffix"
  preview={`<ListBox>
...
<ComponentPreview
  name="core/list-box-disabled-items"
  preview={`<ListBox>
  <Item>Next.js</Item>
  <Item>Remix</Item>
...
<ComponentPreview
  name="core/list-box-uncontrolled"
  preview={`<ListBox
...
<ComponentPreview
  name="core/list-box-composition"
  preview={`<ListBox selectionMode="multiple">
  <Item>
...
<ComponentPreview 
  name="core/list-box-async-loading"
