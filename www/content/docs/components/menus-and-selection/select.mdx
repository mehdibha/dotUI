...
```
  ...
  <Tab value="manual">
    ...
    ```
      ...
      <ComponentSource name="core/select/select" />
...
<ComponentPreview
  name="core/select/select-placeholder"
...
<ComponentPreview
  name="core/select/select-description"
...
<ComponentPreview
  name="core/select/select-contextual-help"
  preview={`<Select
    label="Provider"
...
<ComponentPreview
  name="core/select/select-validation"
...
<ComponentPreview
  name="core/select/select-sections"
...
<ComponentPreview
  name="core/select/select-disabled"
...
<ComponentPreview
  name="core/select/select-loading"
...
<ComponentPreview
  name="core/select/select-required"
...
<ComponentPreview
  name="core/select/select-uncontrolled"
...
<ComponentPreview
  name="core/select/select-controlled"
...
<ComponentPreview
  name="core/select/select-composition"
  preview={`<SelectRoot>
...
<ComponentPreview 
  name="core/select/select-async-loading" 
