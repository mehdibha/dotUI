...
```
  ...
  <Tab value="manual">
    ...
    ```
      ...
      <ComponentSource name="core/dialog/dialog" />
...
<ComponentPreview
  name="core/dialog/dialog-description"
  preview={`<DialogRoot>
    <Button variant="outline">Edit username</Button>
...
<ComponentPreview
  name="core/dialog/dialog-dismissable"
  preview={`<DialogRoot>
    <Button variant="outline">Edit Profile</Button>
    <Dialog
      title="Edit profile"
...
<ComponentPreview
  name="core/dialog/dialog-dismiss-button"
  preview={`<DialogRoot>
    <Button variant="outline">Edit Profile</Button>
    <Dialog
      title="Edit profile"
...
<ComponentPreview
  name="core/dialog/dialog-inset-content"
  preview={`<DialogRoot>
    <Button variant="outline">Edit Profile</Button>
    <Dialog title="Edit profile" description="Make changes to your profile.">
      {({ close }) => (
...
<ComponentPreview name="core/dialog/dialog-popover" preview={``} />

## Drawer

Use the `type="drawer"` prop on the `<Dialog>` element to make a drawer dialog.

<ComponentPreview name="core/dialog/dialog-drawer" preview={``} />
...
<ComponentPreview name="core/dialog/dialog-alert-dialog" preview={``} />

## Controlled

Use the `isOpen` and `onOpenChange` props to control the dialog's open state.

<ComponentPreview name="core/dialog/dialog-controlled" preview={``} />

## Composition

If you need to customize things further, you can drop down to the composition level.

<ComponentPreview name="core/dialog/dialog-composition" preview={``} />
...
<ComponentPreview name="core/dialog/dialog-nested" preview={``} />
