...
<ComponentPreview
  name="core/dialog-dismiss-button"
  preview={`<DialogRoot>
  <Button variant="outline">Edit Profile</Button>
  <Dialog
    title="Edit profile"
...
<ComponentPreview
  name="core/dialog-inset-content"
  preview={`<DialogRoot>
  <Button variant="outline">Edit Profile</Button>
  <Dialog title="Edit profile" description="Make changes to your profile.">
    {({ close }) => (
...
<ComponentPreview name="core/dialog-popover" preview={``} />

## Drawer

Use the `type="drawer"` prop on the `<Dialog>` element to make a drawer dialog.

<ComponentPreview name="core/dialog-drawer" preview={``} />
...
<ComponentPreview name="core/dialog-alert-dialog" preview={``} />

## Controlled

Use the `isOpen` and `onOpenChange` props to control the dialog's open state.

<ComponentPreview name="core/dialog-controlled" preview={``} />

## Composition

If you need to customize things further, you can drop down to the composition level.

<ComponentPreview name="core/dialog-composition" preview={``} />

## Examples

### Async form submission

<ComponentPreview name="core/dialog-async-form-submission" preview={``} />

### Nested dialog

Dialogs support nesting, allowing you to open a dialog from within another dialog.

<ComponentPreview name="core/dialog-nested" preview={``} />
