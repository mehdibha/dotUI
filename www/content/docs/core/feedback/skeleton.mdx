...
<ComponentPreview
  name="core/skeleton/skeleton-card"
...
```
  ...
  <Tab value="manual">
    ...
    <Steps>
      ...
      <ComponentSource name="core/skeleton/skeleton" />
...
<ComponentPreview
  name="core/skeleton/skeleton-children"
  preview={`<Skeleton>
...
<ComponentPreview
  name="core/skeleton/skeleton-show"
  preview={`<Skeleton>
    <Button>Button</Button>
  </Skeleton>
  <Skeleton show={false}>
...
<ComponentPreview
  name="core/skeleton/skeleton-api-simulation"
...
<ComponentPreview
  name="core/skeleton/skeleton-fixed-size-children"
