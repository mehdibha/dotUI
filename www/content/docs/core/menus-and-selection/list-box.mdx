...
<ComponentPreview
  name="core/list-box/list-box-basic"
  preview={`<ListBox>
    <Item>Next.js</Item>
    <Item>Remix</Item>
    <Item>Astro</Item>
...
```
  ...
  <Tab value="manual">
    ...
    ```
      ...
      <ComponentSource name="core/list-box/list-box" />
...
<ComponentPreview
  name="core/list-box/list-box-horizontal"
...
<ComponentPreview
  name="core/list-box/list-box-grid"
...
<ComponentPreview
  name="core/list-box/list-box-selection-mode"
...
<ComponentPreview
  name="core/list-box/list-box-selection-behavior"
...
<ComponentPreview
  name="core/list-box/list-box-loading"
...
<ComponentPreview
  name="core/list-box/list-box-empty-state"
...
<ComponentPreview
  name="core/list-box/list-box-item-variant"
  preview={`<ListBox>
    <Item>View logs</Item>
...
<ComponentPreview
  name="core/list-box/list-box-label-and-description"
  preview={`<ListBox>
    <Item textValue="Read" label="Read" description="Read Only" />
    <Item textValue="Write" label="Write" description="Read and Write Only" />
    <Item textValue="Admin" label="Admin" description="Full access" />
...
<ComponentPreview
  name="core/list-box/list-box-prefix-and-suffix"
  preview={`<ListBox>
...
<ComponentPreview
  name="core/list-box/list-box-links"
  preview={`<ListBox>
...
<ComponentPreview
  name="core/list-box/list-box-disabled-items"
  preview={`<ListBox>
    <Item>Next.js</Item>
    <Item>Remix</Item>
...
<ComponentPreview
  name="core/list-box/list-box-sections"
...
<ComponentPreview
  name="core/list-box/list-box-separator"
  preview={`<ListBox>
    <Item>New...</Item>
    <Item>Badges</Item>
    <Separator />
...
<ComponentPreview
  name="core/list-box/list-box-uncontrolled"
  preview={`<ListBox
...
<ComponentPreview
  name="core/list-box/list-box-controlled"
...
<ComponentPreview
  name="core/list-box/list-box-composition"
  preview={`<ListBox selectionMode="multiple">
    <Item>
...
<ComponentPreview 
  name="core/list-box/list-box-async-loading"
