...
```
  ...
  <Tab value="manual">
    ...
    ```
      ...
      <ComponentSource name="core/menu/menu" />
...
<ComponentPreview
  name="core/menu/menu-overlay-type"
  preview={`<MenuRoot>
    <Button><MenuIcon /></Button>
...
<ComponentPreview
  name="core/menu/menu-single-selection"
...
<ComponentPreview
  name="core/menu/menu-multiple-selection"
  preview={`<MenuRoot>
...
<ComponentPreview
  name="core/menu/menu-item-variant"
  preview={`<MenuRoot>
    <Button><MenuIcon /></Button>
    <Menu>
      <MenuItem>Account settings</MenuItem>
...
<ComponentPreview
  name="core/menu/menu-label-and-description"
  preview={`<MenuRoot>
    <Button><MenuIcon /></Button>
    <Menu>
...
<ComponentPreview
  name="core/menu/menu-prefix-and-suffix"
  preview={`<MenuRoot>
    <Button><MenuIcon /></Button>
    <Menu>
...
<ComponentPreview
  name="core/menu/menu-link-items"
  preview={`<MenuRoot>
...
<ComponentPreview
  name="core/menu/menu-disabled-items"
  preview={`<MenuRoot>
    <Button><MenuIcon /></Button>
    <Menu>
      <MenuItem>Account settings</MenuItem>
...
<ComponentPreview
  name="core/menu/menu-long-press"
...
<ComponentPreview
  name="core/menu/menu-controlled"
...
<ComponentPreview
  name="core/menu/menu-composition"
  preview={`<MenuRoot>
    <Button>
      <MenuIcon />
    </Button>
