...
<ComponentPreview name="core/table/table-selection-variant" />
...
<ComponentPreview name="core/table/table-empty-state" />

## Column resizing

<ComponentPreview name="core/table/table-column-resizing" />
