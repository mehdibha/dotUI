...
<ComponentPreview
  name="core/text-area-prefix-and-suffix"
  preview={`<TextArea
  label="Comment"
...
<ComponentPreview
  name="core/text-area-description"
...
<ComponentPreview
  name="core/text-area-contextual-help"
...
<ComponentPreview
  name="core/text-area-error-message"
  preview={`<TextArea 
  label="Comment"
  isInvalid
...
<ComponentPreview
  name="core/text-area-uncontrolled"
...
<ComponentPreview
  name="core/text-area-controlled"
...
<ComponentPreview
  name="core/text-area-composition"
