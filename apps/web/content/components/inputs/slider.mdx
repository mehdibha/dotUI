...
<ComponentPreview
  name="core/slider-format-options"
...
<ComponentPreview
  name="core/slider-advanced-composition"
  preview={`<SliderRoot>
  <Label>Volume</Label>
  <SliderValueLabel />
  <div>
