...
<ComponentPreview
  name="demos/components/core/progress/custom-value-label"
  preview={``}
/>
...
<ComponentPreview
  name="demos/components/core/progress/indeterminate"
  preview={``}
/>
...
<ComponentPreview
  name="demos/components/core/progress/min-max-values"
  preview={``}
/>
...
<ComponentPreview
  name="demos/components/core/progress/composition"
  preview={``}
/>
...
<ComponentPreview
  name="demos/components/core/progress/custom-color"
  preview={``}
/>
