...
const calendarVariants = tv({
  slots: {
    ...
    cell: "relative flex aspect-square size-full items-center justify-center text-center text-sm font-medium no-highlight min-w-(--cell-size) cursor-interactive disabled:text-(--disabled-fg,currentColor) unavailable:text-fg-disabled unavailable:line-through outside-month:text-fg-disabled in-data-range-calendar:not-outside-month:selected:bg-accent-muted focus-reset transition-shadow in-data-calendar:hover:bg-accent-muted in-data-calendar:focus-visible:focus-ring in-data-calendar:selected:not-outside-month:bg-accent in-data-calendar:selected:not-outside-month:text-fg-on-accent outside-month:pointer-events-none in-data-calendar:not-outside-month:invalid:selected:bg-danger in-data-calendar:not-outside-month:invalid:selected:text-fg-on-danger in-data-calendar:rounded-(--cell-radius) selection-start:rounded-l-full selection-end:rounded-r-full in-data-range-calendar:[td:has(+td>[data-outside-month])>&[data-selected]:not([data-selection-end])]:rounded-r-xs in-data-range-calendar:[td:has(>[data-outside-month])+td>&[data-selected]:not([data-selection-start])]:rounded-l-xs in-data-range-calendar:[td:first-child>&[data-selected]:not([data-selection-start])]:rounded-l-xs in-data-range-calendar:[td:last-child>&[data-selected]:not([data-selection-end])]:rounded-r-xs",
    cellInner:
