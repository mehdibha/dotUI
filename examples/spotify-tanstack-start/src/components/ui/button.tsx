...
const buttonVariants = tv({
  ...
  variants: {
    variant: {
      ...
      secondary:
        "border bg-neutral text-fg-on-neutral disabled:border-(--disabled-border,var(--color-border-control)) disabled:bg-(--disabled-bg,var(--color-neutral)) disabled:text-(--disabled-fg,var(--color-fg-on-neutral)) pending:border-border hover:bg-neutral-hover pressed:bg-neutral-active",
      quiet:
