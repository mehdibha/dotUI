...
const drawerVariants = tv({
  ...
  variants: {
    ...
    effect: {
      ...
      push: {
        indent:
          "origin-left duration-[calc(500ms*(1-clamp(0,calc(var(--drawer-swipe-progress,0)*100000),1)))] *:transition-opacity *:duration-[inherit] after:pointer-events-none after:absolute after:inset-0 after:z-10 after:rounded-[inherit] data-active:transform-[translate3d(calc(var(--drawer-indent-push,min(85vw,--spacing(80)))*(1-var(--drawer-swipe-progress,0))),0,0)] data-active:overflow-hidden data-active:rounded-xl data-active:*:opacity-[calc(0.4+0.6*var(--drawer-swipe-progress,0))] data-active:after:shadow-[inset_0_0_0_1px_var(--color-border-control)]",
      },
    },
  },
  defaultVariants: {
