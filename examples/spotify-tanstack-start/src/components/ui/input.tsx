...
const inputVariants = tv({
  slots: {
    ...
    input:
      "inline-flex w-full cursor-text items-center outline-none h-(--input-h) in-data-input-group:h-auto disabled:cursor-disabled disabled:text-(--disabled-fg,currentColor) text-base sm:text-sm rounded-md border border-transparent bg-field px-(--edge-to-text) shadow-(--shadow-control,0_0_#0000) transition-[box-shadow,border-color,color] invalid:border-border-danger invalid:ring-danger-muted disabled:bg-(--disabled-bg,var(--color-field)) focus:focus-input focus:not-invalid:border-border-focus",
    textArea:
      "min-h-16 w-full resize-none py-(--top-to-text) outline-none disabled:cursor-disabled disabled:text-(--disabled-fg,currentColor) text-base sm:text-sm rounded-md border border-transparent bg-field px-(--edge-to-text) shadow-(--shadow-control,0_0_#0000) transition-[box-shadow,border-color,color] invalid:border-border-danger invalid:ring-danger-muted disabled:bg-(--disabled-bg,var(--color-field)) focus:focus-input focus:not-invalid:border-border-focus",
    dateInputSegment:
