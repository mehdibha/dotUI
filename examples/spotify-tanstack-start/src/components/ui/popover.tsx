...
const popoverVariants = tv({
  slots: {
    popover: [
      "popover z-50 min-w-[max(var(--trigger-width),--spacing(32))] origin-(--trigger-anchor-point) rounded-lg border border-(--overlay-border) bg-popover shadow-[var(--shadow-popover,var(--shadow-md))] [backdrop-filter:var(--overlay-backdrop-filter,none)] forced-color-adjust-none outline-none [--surface-radius:var(--popover-radius)]",
