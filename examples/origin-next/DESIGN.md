...
version: alpha
name: "Design system"
description: "Design system — a dotUI design system: brand-colored primary actions, hairline surfaces, default density, 10px base radius, Geist type."
colors:
  primary: "oklch(0.5787 0.2113 258.04)"
  on-primary: "oklch(1 0 0)"
  background: "oklch(0.992 0.0021 258.04)"
  foreground: "oklch(0.2399 0.0126 258.04)"
  foreground-muted: "oklch(0.4997 0.013 258.04)"
  surface: "oklch(0.9831 0.003 258.04)"
  popover: "oklch(0.9831 0.003 258.04)"
  muted: "oklch(0.956 0.0042 258.04)"
  border: "oklch(0.921 0.006 258.04)"
  border-control: "oklch(0.8827 0.0074 258.04)"
  focus: "oklch(0.5787 0.2113 258.04)"
  accent: "oklch(0.5787 0.2113 258.04)"
...
Design system is built on **dotUI**: React Aria Components styled with Tailwind CSS v4 and tailwind-variants. Its character: brand-colored primary actions, hairline surfaces, default density, 10px base radius, Geist type.
...
- Body: Geist (`font-sans`), 14px (`text-sm`) in product UI. Headings: the body family — `h1`–`h6` pick up the heading font and weight automatically. Code and numbers that must align: Geist Mono (`font-mono`, `tabular-nums`).
