...
const segmentedControlVariants = tv({
  slots: {
    root: [
      "inline-flex w-fit items-center justify-center rounded-lg text-fg-muted",
      "bg-muted p-[3px]",
    ],
    item: [
      "relative isolate inline-flex cursor-default items-center justify-center rounded-md border border-transparent font-medium whitespace-nowrap focus-reset transition-[color] select-ui focus-visible:focus-ring",
