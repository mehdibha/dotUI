...
const tableVariants = tv({
  slots: {
    ...
    selectionCell:
      "w-10 min-w-10 px-2.5 [div]:h-[calc(100%-1px)] [div]:justify-start px-2.5",
    dragCell:
      "w-8 min-w-8 cursor-drag px-1 text-fg-muted group-dragging/row:cursor-dragging [div]:justify-center px-1",
    dragButton:
