...
const tagGroupVariants = tv({
  slots: {
    ...
    tag: [
      "group/tag relative inline-flex w-fit shrink-0 cursor-default items-center justify-center gap-1 rounded-md font-medium whitespace-nowrap outline-hidden transition-colors select-ui data-react-aria-pressable:cursor-interactive",
      ...
      "bg-neutral text-fg-on-neutral disabled:bg-(--disabled-bg,var(--color-neutral)) disabled:text-(--disabled-fg,var(--color-fg-on-neutral)) selected:bg-accent-muted selected:text-fg-accent",
    ],
  },
});
