...
const markerVariants = tv({
  slots: {
    root: "group/marker relative flex w-full items-center text-left text-fg-muted **:[a]:underline **:[a]:underline-offset-3 **:[a]:hover:text-fg min-h-4 gap-2.5 text-sm **:[svg]:not-with-[size]:size-4",
