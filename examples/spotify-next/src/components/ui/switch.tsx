...
const switchVariants = tv({
  slots: {
    ...
    indicator:
      "inline-flex shrink-0 cursor-pointer items-center rounded-full border border-transparent bg-border-control p-0.5 transition-[background-color,border-color,box-shadow] duration-200 selected:bg-selection read-only:cursor-default disabled:cursor-disabled disabled:border-(--disabled-border,transparent) disabled:bg-(--disabled-unselected-bg,var(--color-neutral)) disabled:selected:border-transparent disabled:selected:bg-(--disabled-selected-bg,var(--color-selection))",
    thumb:
