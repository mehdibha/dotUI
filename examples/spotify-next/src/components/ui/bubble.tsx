...
const bubbleVariants = tv({
  slots: {
    ...
    content:
      "w-fit max-w-full min-w-0 overflow-hidden rounded-lg border border-transparent wrap-break-word group-data-[align=end]/bubble:self-end px-4 py-2.5 text-sm leading-relaxed",
    reactions:
