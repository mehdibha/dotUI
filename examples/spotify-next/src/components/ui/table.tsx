...
const tableVariants = tv({
  slots: {
    container:
      "relative isolate min-h-0 w-full scroll-pt-10 overflow-auto rounded-md border bg-bg scroll-pt-12",
    ...
    column:
      "box-border h-10 cursor-default px-2.5 text-left align-middle font-medium whitespace-nowrap text-fg-muted focus-reset outline-hidden first:rounded-tl-[calc(var(--radius-md)-1px)] last:rounded-tr-[calc(var(--radius-md)-1px)] [div]:flex [div]:h-full [div]:items-center relative hover:text-fg focus-visible:z-20 focus-visible:text-fg focus-visible:before:pointer-events-none focus-visible:before:absolute focus-visible:before:inset-0 focus-visible:before:rounded-md focus-visible:before:[outline:var(--focus-ring-width)_solid_var(--focus-ring-color)] focus-visible:before:[outline-offset:calc(var(--focus-ring-width)*-1)] focus-visible:before:content-[''] h-12 px-3 border-b bg-bg/95 backdrop-blur supports-[-moz-appearance:none]:bg-bg",
    columnContent: "flex h-full min-w-0 items-center gap-1.5",
    columnLabel: "min-w-0 flex-1 truncate",
    chromeColumn:
      "box-border h-10 px-0 text-left align-middle focus-reset outline-hidden first:rounded-tl-[calc(var(--radius-md)-1px)] last:rounded-tr-[calc(var(--radius-md)-1px)] [div]:flex [div]:h-full [div]:items-center relative focus-visible:z-20 focus-visible:before:pointer-events-none focus-visible:before:absolute focus-visible:before:inset-0 focus-visible:before:rounded-md focus-visible:before:[outline:var(--focus-ring-width)_solid_var(--focus-ring-color)] focus-visible:before:[outline-offset:calc(var(--focus-ring-width)*-1)] focus-visible:before:content-[''] h-12 border-b bg-bg/95 backdrop-blur supports-[-moz-appearance:none]:bg-bg",
    ...
    dragButton:
      "inline-flex size-6 cursor-drag items-center justify-center rounded-sm text-fg-muted focus-reset transition-colors focus-visible:focus-ring group-hover/row:text-fg group-dragging/row:cursor-dragging focus-visible:bg-muted focus-visible:text-fg **:[svg]:size-4",
