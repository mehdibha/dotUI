...
const toastVariants = tv({
  slots: {
    ...
    action:
      "inline-flex h-7 max-w-32 items-center justify-center rounded-full bg-neutral px-2.5 text-xs font-medium text-fg-on-neutral focus-reset transition-colors empty:hidden hover:bg-neutral-hover focus-visible:focus-ring active:bg-neutral-active **:[span]:truncate",
  },
  variants: {
    position: {
      "top-left": {},
