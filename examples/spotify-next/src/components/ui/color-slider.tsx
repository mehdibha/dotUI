...
const colorSliderVariants = tv({
  slots: {
    ...
    track:
      "relative rounded-full disabled:[background:var(--color-disabled)]! orientation-horizontal:**:data-[slot=color-thumb]:top-1/2 orientation-vertical:**:data-[slot=color-thumb]:left-1/2",
  },
  variants: {
    orientation: {
      horizontal: {
