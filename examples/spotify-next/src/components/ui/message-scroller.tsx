...
const messageScrollerVariants = tv({
  slots: {
    ...
    button:
      "absolute inset-s-1/2 -translate-x-1/2 rtl:translate-x-1/2 transition-[translate,scale,opacity] duration-200 ease-[cubic-bezier(0.23,1,0.32,1)] data-[active=false]:duration-400 data-[active=false]:ease-[cubic-bezier(0.7,0,0.84,0)] data-[active=false]:pointer-events-none data-[active=false]:scale-95 data-[active=false]:opacity-0 data-[active=true]:translate-y-0 data-[active=true]:scale-100 data-[active=true]:opacity-100 data-[direction=end]:bottom-4 data-[direction=end]:data-[active=false]:translate-y-full data-[direction=start]:top-4 data-[direction=start]:data-[active=false]:-translate-y-full data-[direction=start]:*:[svg]:rotate-180",
  },
});

const { root, viewport, content, item, button } = messageScrollerVariants();
