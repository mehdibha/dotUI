...
const ComboboxInput = ({ className, ...props }: InputProps) => (
  ...
  >
    <Input
      className={(values) =>
        cn(
          "bg-background flex w-full px-3 py-2 text-sm placeholder:text-fg-muted data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50 data-[focused]:outline-none",
