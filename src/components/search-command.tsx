...
import type { ButtonProps } from "@/lib/components/core/default/button";
import { docsConfig } from "@/config/docs-config";
import { Button } from "./ui/button";

export const SearchCommand = (props: ButtonProps) => {
  ...
  return (
    <>
      ...
      <CommandDialog
        ...
        dialogContentProps={{ className: "overflow-visible" }}
      >
