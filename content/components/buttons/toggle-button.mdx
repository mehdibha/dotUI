...
links:
  ...
  - label: Edit this page
    href: https://github.com/mehdibha/dotUI/tree/main/content/components/buttons/toggle-button.mdx
---
...
Use the `shape` prop to control the shape of the toggle button. The default variant is `"rectangle"`.<br/>
