...
<ComponentPreview name="demos/components/core/file-trigger/default" />
...
<ComponentPreview name="demos/components/core/file-trigger/file-types" />

### Multiple files

A file trigger can accept multiple files by passsing the `allowsMultiple` property.

<ComponentPreview name="demos/components/core/file-trigger/multiple-files" />
...
<ComponentPreview name="demos/components/core/file-trigger/directory-selection" />
...
<ComponentPreview name="demos/components/core/file-trigger/media-capture" />
...
| Key     | Description            |
| ------- | ---------------------- |
| `Space` | Activates the trigger. |
| `Enter` | Activates the trigger. |
