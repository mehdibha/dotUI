...
<ComponentPreview name="demos/components/core/date-field/disabled" className="max-w-[250px]" />
...
<ComponentPreview name="demos/components/core/date-field/read-only" className="max-w-[250px]" />
...
<ComponentPreview name="demos/components/core/date-field/controlled" className="max-w-[250px]" />

### Composition

If you need to customize things further, you can drop down to the composition level.

<ComponentPreview name="demos/components/core/date-field/composition" className="max-w-[250px]" />
