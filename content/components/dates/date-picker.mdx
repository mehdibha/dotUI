...
<ComponentPreview name="demos/components/core/date-picker/disabled" className="max-w-[250px]" />
...
<ComponentPreview name="demos/components/core/date-picker/read-only" className="max-w-[250px]" />
...
<ComponentPreview name="demos/components/core/date-picker/required" className="max-w-sm" />
...
<ComponentPreview name="demos/components/core/date-picker/controlled" className="max-w-[250px]" />

### Composition

If you need to customize things further, you can drop down to the composition level.

<ComponentPreview name="demos/components/core/date-picker/composition" className="max-w-[250px]" />
