...
```
  ...
  <ComponentSource name={["components/core/default/menu","components/core/default/overlay","components/core/default/kbd"]} />
...
Submenus can be created by wrapping a `MenuItem` and a `Menu` in a `SubMenu`.
