...
<ComponentPreview
  name="demos/components/core/dialog/default"
  preview={`<DialogRoot>
...
<ComponentPreview name="demos/components/core/dialog/title" preview={``} />

### Description

A description can be supplied to the dialog via the `description` prop.

<ComponentPreview name="demos/components/core/dialog/description" preview={``} />

### Type

Dialogs can be rendered as modals, popovers, or drawers.

<ComponentPreview name="demos/components/core/dialog/types" preview={``} />

### Mobile type

By default, dialogs are displayed as drawers on mobile. You can override this behavior by setting the `mobileType` prop.

<ComponentPreview name="demos/components/core/dialog/mobile-type" preview={``} />
...
<ComponentPreview name="demos/components/core/dialog/dismissable" preview={``} />
...
<ComponentPreview name="demos/components/core/dialog/dismiss-button" preview={``} />

### Inset content

Use the `<DialogInset>` component to add inset content to the dialog.

<ComponentPreview name="demos/components/core/dialog/inset-content" preview={``} />
