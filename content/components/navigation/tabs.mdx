...
<ComponentPreview name="demos/components/core/tabs/vertical" />

### Disabled

Use the `isDisabled` prop to disable the tabs.

<ComponentPreview name="demos/components/core/tabs/disabled" />

An individual Tab can also be disabled with the `isDisabled` prop.

<ComponentPreview name="demos/components/core/tabs/disabled-item" />

### Keyboard activation

Prevent keyboard activation of tabs by setting `keyboardActivation` prop to `'manual'`.

<ComponentPreview name="demos/components/core/tabs/keyboard-activation" />

## Controlled

Use the `selectedKey` prop to control the selected tab.

<ComponentPreview name="demos/components/core/tabs/controlled" />
