...
<ComponentPreview name="demos/components/core/link/default" />
...
<ComponentPreview name="demos/components/core/link/variants" />

### Disabled

Use the `isDisabled` prop to disable the link.

<ComponentPreview name="demos/components/core/link/disabled" />

## Examples

### With icon

<ComponentPreview name="demos/components/core/link/icon" />
