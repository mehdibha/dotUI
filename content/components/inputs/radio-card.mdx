---
title: Radio
description: Radio card is a button for making a single selection from a short list of options.
thumbnail:
...
```
  ...
  <ComponentSource name="components/core/default/radio/radio-card" />
  <Step>Update the import paths to match your project setup.</Step>
</Steps>

## Usage

Use a radio card in a radio group to allow users to select one option from a short list of options.

## Options

### Title

A title can be supplied to a `RadioCard` via the `title` prop.

<ComponentPreview name="demos/components/core/radio-card/title" />

### Description

A description can be supplied to a `RadioCard` via the `description` prop.

<ComponentPreview name="demos/components/core/radio-card/description" />

### Disabled

Use the `isDisabled` prop to disable the Radio.

<ComponentPreview name="demos/components/core/radio-card/disabled" />
...
| `title`       | `string`                                                                                           | The title of the radio card                                                                                            |
| `description` | `string`                                                                                           | The description of the radio card                                                                                      |
