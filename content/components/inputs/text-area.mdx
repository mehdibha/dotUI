...
links:
  ...
  - label: Edit this page
    href: https://github.com/mehdibha/dotUI/tree/main/content/components/inputs/text-area.mdx
---
...
<ComponentPreview
  ...
  preview={`<salem label="Description" />
<salem aria-label="Description" />`}
/>
...
<ComponentPreview
  ...
  preview={`<salem label="Description" description="Type your description" />`}
/>
...
<ComponentPreview
  ...
  preview={`<salem label="Bio" contextualHelp={<ContextualHelp />} />`}
/>
...
<ComponentPreview
  ...
  preview={`<salem isLoading loaderPosition="prefix" />
<salem isLoading loaderPosition="suffix" />`}
/>
...
<ComponentPreview
  ...
  preview={`<salem label="Description" isRequired necessityIndicator="icon" />`}
/>
...
<ComponentPreview
  ...
  preview={`<salem label="Essay" defaultValue="Roses are red, violets are blue." />`}
/>
