...
<ComponentPreview name="demos/components/core/checkbox-group/label" className="max-w-[250px]" />
...
<ComponentPreview name="demos/components/core/checkbox-group/disabled" className="max-w-[250px]" />
...
<ComponentPreview name="demos/components/core/checkbox-group/read-only" className="max-w-[250px]" />
...
<ComponentPreview name="demos/components/core/checkbox-group/required" className="max-w-md" />

## Examples

### Cards

<ComponentPreview name="demos/components/core/checkbox-group/cards" className="max-w-[250px]" />
