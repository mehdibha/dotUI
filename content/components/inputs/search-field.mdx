...
<ComponentPreview name="demos/components/core/search-field/default" className="max-w-[250px]" />
...
<ComponentPreview name="demos/components/core/search-field/variants" className="max-w-[250px]" />
...
<ComponentPreview name="demos/components/core/search-field/label" className="max-w-[250px]" />
...
<ComponentPreview name="demos/components/core/search-field/description" className="max-w-[250px]" />
...
<ComponentPreview name="demos/components/core/search-field/loading" className="max-w-xs" />

### Disabled

Use the `isDisabled` prop to disable the SearchField.

<ComponentPreview name="demos/components/core/search-field/disabled" className="max-w-[250px]" />
...
<ComponentPreview name="demos/components/core/search-field/read-only" className="max-w-[250px]" />
...
<ComponentPreview name="demos/components/core/search-field/required" className="max-w-sm" />
...
<ComponentPreview name="demos/components/core/search-field/controlled" className="max-w-[250px]" />

### Composition

If you need to customize things further, you can drop down to the composition level.

<ComponentPreview name="demos/components/core/search-field/composition" className="max-w-[250px]" />
