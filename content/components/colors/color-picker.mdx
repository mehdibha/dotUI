...
<ComponentPreview name="demos/components/core/color-picker/uncontrolled" preview={``} />
...
<ComponentPreview name="demos/components/core/color-picker/composition" preview={``} />
